...
class DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final double a(double d2, DurationUnit durationUnit, DurationUnit durationUnit2) {
        Intrinsics.i(durationUnit, "sourceUnit");
        Intrinsics.i(durationUnit2, "targetUnit");
        long convert = durationUnit2.f().convert(1, durationUnit.f());
        return convert > 0 ? d2 * ((double) convert) : d2 / ((double) durationUnit.f().convert(1, durationUnit2.f()));
    }

    public static final long b(long j2, DurationUnit durationUnit, DurationUnit durationUnit2) {
        Intrinsics.i(durationUnit, "sourceUnit");
        Intrinsics.i(durationUnit2, "targetUnit");
        return durationUnit2.f().convert(j2, durationUnit.f());
    }
