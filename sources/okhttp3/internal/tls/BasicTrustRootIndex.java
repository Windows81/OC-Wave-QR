...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public final Map f43243a;

    public BasicTrustRootIndex(X509Certificate... x509CertificateArr) {
        Intrinsics.i(x509CertificateArr, "caCerts");
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        for (X509Certificate x509Certificate : x509CertificateArr) {
            X500Principal subjectX500Principal = x509Certificate.getSubjectX500Principal();
            Intrinsics.h(subjectX500Principal, "caCert.subjectX500Principal");
    ...
    public boolean equals(Object obj) {
        return obj == this || ((obj instanceof BasicTrustRootIndex) && Intrinsics.d(((BasicTrustRootIndex) obj).f43243a, this.f43243a));
    }
