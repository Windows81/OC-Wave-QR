...
public final class HostnamesKt {
    public static final boolean a(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (Intrinsics.k(charAt, 31) <= 0 || Intrinsics.k(charAt, 127) >= 0 || StringsKt.i0(" #%/:?@[\\]", charAt, 0, false, 6, (Object) null) != -1) {
                return true;
            }
        }
        return false;
    ...
    public static final boolean b(String str, int i2, int i3, byte[] bArr, int i4) {
        int i5 = i4;
        while (i2 < i3) {
            if (i5 == bArr.length) {
                return false;
            ...
            while (i6 < i3) {
                ...
                if (Intrinsics.k(charAt, 48) < 0 || Intrinsics.k(charAt, 57) > 0) {
                    break;
    ...
    public static final java.net.InetAddress c(java.lang.String r18, int r19, int r20) {
        ...
        L_0x0015:
            ...
            r10 = r5
            r5 = r17
            boolean r0 = kotlin.text.StringsKt.P(r0, r1, r2, r3, r4, r5)
    ...
    public static final String d(byte[] bArr) {
        ...
        while (i3 < bArr.length) {
            if (i3 == i2) {
                ...
                buffer.Q0((long) ((Util.d(bArr[i3], 255) << 8) | Util.d(bArr[i3 + 1], 255)));
                i3 += 2;
            }
        }
        return buffer.e0();
    ...
    public static final String e(String str) {
        ...
        if (StringsKt.W(str, ":", false, 2, (Object) null)) {
            InetAddress c2 = (!StringsKt.Q(str, "[", false, 2, (Object) null) || !StringsKt.A(str, "]", false, 2, (Object) null)) ? c(str, 0, str.length()) : c(str, 1, str.length() - 1);
            if (c2 == null) {
                return null;
            }
            ...
            try {
                ...
                Intrinsics.h(ascii, "toASCII(host)");
