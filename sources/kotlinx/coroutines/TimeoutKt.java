...
public final class TimeoutKt {
    ...
    public static final kotlinx.coroutines.TimeoutCancellationException a(long r2, kotlinx.coroutines.Delay r4, kotlinx.coroutines.Job r5) {
        ...
        L_0x0008:
            ...
            kotlin.time.Duration$Companion r0 = kotlin.time.Duration.f41206A
    ...
    public static final Object b(TimeoutCoroutine timeoutCoroutine, Function2 function2) {
        JobKt.h(timeoutCoroutine, DelayKt.d(timeoutCoroutine.C.f()).O(timeoutCoroutine.D, timeoutCoroutine, timeoutCoroutine.f()));
        return UndispatchedKt.e(timeoutCoroutine, timeoutCoroutine, function2);
    }

    public static final Object c(long j2, Function2 function2, Continuation continuation) {
        if (j2 > 0) {
            Object b2 = b(new TimeoutCoroutine(j2, continuation), function2);
            if (b2 == IntrinsicsKt.f()) {
    ...
    public static final java.lang.Object d(long r7, kotlin.jvm.functions.Function2 r9, kotlin.coroutines.Continuation r10) {
        ...
        L_0x0046:
            ...
            r0.E = r10     // Catch:{ TimeoutCancellationException -> 0x0068 }
            r0.C = r7     // Catch:{ TimeoutCancellationException -> 0x0068 }
            r0.G = r4     // Catch:{ TimeoutCancellationException -> 0x0068 }
            ...
            r10.f40908z = r2     // Catch:{ TimeoutCancellationException -> 0x0068 }
            java.lang.Object r7 = b(r2, r9)     // Catch:{ TimeoutCancellationException -> 0x0068 }
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt.f()     // Catch:{ TimeoutCancellationException -> 0x0068 }
        ...
        L_0x006f:
            return r10
        L_0x0070:
            kotlinx.coroutines.Job r9 = r8.f41439z
