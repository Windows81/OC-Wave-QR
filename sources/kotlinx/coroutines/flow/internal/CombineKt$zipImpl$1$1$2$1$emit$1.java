...
public final class CombineKt$zipImpl$1$1$2$1$emit$1 extends ContinuationImpl {
    ...
    public final /* synthetic */ CombineKt$zipImpl$1$1.AnonymousClass2.AnonymousClass1 D;
    public int E;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CombineKt$zipImpl$1$1$2$1$emit$1(CombineKt$zipImpl$1$1.AnonymousClass2.AnonymousClass1 r1, Continuation continuation) {
        super(continuation);
        this.D = r1;
    }
