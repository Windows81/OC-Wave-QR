...
public abstract class AdIdManager {
    ...
    public static final Companion f22670a = new Companion((DefaultConstructorMarker) null);

    @Metadata
    public static final class Api33Ext4Impl extends AdIdManager {

        /* renamed from: b  reason: collision with root package name */
        public final android.adservices.adid.AdIdManager f22671b;

        /* JADX WARNING: Removed duplicated region for block: B:12:0x0035  */
        /* JADX WARNING: Removed duplicated region for block: B:8:0x0023  */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.lang.Object a(kotlin.coroutines.Continuation<? super androidx.privacysandbox.ads.adservices.adid.AdId> r5) {
            /*
                r4 = this;
            ...
            L_0x0043:
                r0 = r4
            L_0x0044:
                android.adservices.adid.AdId r5 = androidx.privacysandbox.ads.adservices.adid.a.a(r5)
                androidx.privacysandbox.ads.adservices.adid.AdId r5 = r0.c(r5)
                return r5
            */
        ...
        public final AdId c(AdId adId) {
            String a2 = adId.getAdId();
            Intrinsics.h(a2, "response.adId");
            return new AdId(a2, adId.isLimitAdTrackingEnabled());
        }

        public final Object d(Continuation continuation) {
            CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.c(continuation), 1);
            cancellableContinuationImpl.G();
            this.f22671b.getAdId(new e(), OutcomeReceiverKt.a(cancellableContinuationImpl));
