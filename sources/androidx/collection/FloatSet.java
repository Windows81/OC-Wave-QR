...
public abstract class FloatSet {
    ...
    public static /* synthetic */ String d(FloatSet floatSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i2, CharSequence charSequence4, int i3, Object obj) {
        if (obj == null) {
            ...
            return floatSet.c(charSequence, charSequence6, charSequence5, i4, charSequence4);
        }
    ...
    public final boolean a(float r17) {
        ...
        L_0x006d:
            ...
            goto L_0x0016
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.FloatSet.a(float):boolean");
    }
    ...
    public FloatSet() {
        this.f1761a = ScatterMapKt.f1964a;
        this.f1762b = FloatSetKt.a();
    }
}
