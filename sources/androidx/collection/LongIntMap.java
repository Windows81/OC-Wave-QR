...
public abstract class LongIntMap {
    ...
    public final int b(long j2) {
        int a2 = a(j2);
        if (a2 < 0) {
            RuntimeHelpersKt.d("Cannot find value for key " + j2);
        }
        return this.f1814c[a2];
    }
    ...
    public LongIntMap() {
        this.f1812a = ScatterMapKt.f1964a;
        this.f1813b = LongSetKt.a();
        this.f1814c = IntSetKt.a();
    }
}
