...
public abstract class IntIntMap {
    ...
    public final int c(int i2) {
        int b2 = b(i2);
        if (b2 < 0) {
            RuntimeHelpersKt.d("Cannot find value for key " + i2);
        }
        return this.f1778c[b2];
    }
    ...
    public IntIntMap() {
        this.f1776a = ScatterMapKt.f1964a;
        this.f1777b = IntSetKt.a();
        this.f1778c = IntSetKt.a();
    }
}
