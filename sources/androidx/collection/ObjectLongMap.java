...
public abstract class ObjectLongMap<K> {
    ...
    public final int a(Object obj) {
        ...
        while (true) {
            ...
            for (long j4 = (~j3) & (j3 - 72340172838076673L) & -9187201950435737472L; j4 != 0; j4 &= j4 - 1) {
                ...
                if (Intrinsics.d(this.f1943b[numberOfTrailingZeros], obj)) {
    ...
    public int hashCode() {
        Object[] objArr = this.f1943b;
        long[] jArr = this.f1944c;
        long[] jArr2 = this.f1942a;
    ...
    public ObjectLongMap() {
        this.f1942a = ScatterMapKt.f1964a;
        this.f1943b = ContainerHelpersKt.f2008c;
        this.f1944c = LongSetKt.a();
    }
}
