...
public final class PathParser {
    ...
    public static boolean b(PathDataNode[] pathDataNodeArr, PathDataNode[] pathDataNodeArr2) {
        ...
        for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
            if (pathDataNodeArr[i2].f19781a != pathDataNodeArr2[i2].f19781a || pathDataNodeArr[i2].f19782b.length != pathDataNodeArr2[i2].f19782b.length) {
                return false;
            }
        }
        return true;
    ...
    public static PathDataNode[] d(String str) {
        ...
        while (i3 < str.length()) {
            int h2 = h(str, i3);
            String trim = str.substring(i2, h2).trim();
            if (!trim.isEmpty()) {
                a(arrayList, trim.charAt(0), g(trim));
            }
            i2 = h2;
            i3 = h2 + 1;
        }
    ...
    public static void f(java.lang.String r8, int r9, androidx.core.graphics.PathParser.ExtractFloatResult r10) {
        /*
            r0 = 0
            r10.f19780b = r0
            r1 = r9
        ...
        L_0x003c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.PathParser.f(java.lang.String, int, androidx.core.graphics.PathParser$ExtractFloatResult):void");
    }
    ...
    public static float[] g(String str) {
        ...
        try {
            ...
            int i3 = 0;
            while (i2 < length) {
                f(str, i2, extractFloatResult);
                int i4 = extractFloatResult.f19779a;
                if (i2 < i4) {
                    fArr[i3] = Float.parseFloat(str.substring(i2, i4));
                    i3++;
                }
                i2 = extractFloatResult.f19780b ? i4 : i4 + 1;
            }
            return c(fArr, 0, i3);
    ...
    public static void i(PathDataNode[] pathDataNodeArr, Path path) {
        ...
        for (PathDataNode pathDataNode : pathDataNodeArr) {
            PathDataNode.e(path, fArr, c2, pathDataNode.f19781a, pathDataNode.f19782b);
            c2 = pathDataNode.f19781a;
        }
    }
    ...
    public static void j(PathDataNode[] pathDataNodeArr, PathDataNode[] pathDataNodeArr2) {
        for (int i2 = 0; i2 < pathDataNodeArr2.length; i2++) {
            char unused = pathDataNodeArr[i2].f19781a = pathDataNodeArr2[i2].f19781a;
            for (int i3 = 0; i3 < pathDataNodeArr2[i2].f19782b.length; i3++) {
                pathDataNodeArr[i2].f19782b[i3] = pathDataNodeArr2[i2].f19782b[i3];
            }
        }
    }
    ...
    public static class PathDataNode {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:104:0x021c, code lost:
            r24 = r7;
            g(r25, r9, r8, r3, r4, r5, r6, r15, r22, r23);
            r9 = r9 + r12[r13];
            r8 = r8 + r12[r14];
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:118:0x02c5, code lost:
            g(r25, r11, r15, r3, r4, r5, r6, r7, r8, r9);
            r9 = r12[r13];
            r8 = r12[r14];
         */
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static void e(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            /*
                r10 = r25
                r11 = r28
                r12 = r29
            ...
            L_0x02dc:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.PathParser.PathDataNode.e(android.graphics.Path, float[], char, char, float[]):void");
        }

        public static void f(Path path, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10) {
            double d11 = d4;
        ...
        public static void g(Path path, float f2, float f3, float f4, float f5, float f6, float f7, float f8, boolean z2, boolean z3) {
            double d2;
            double d3;
            float f9 = f2;
            float f10 = f4;
            ...
            if (d24 < 0.0d) {
                ...
                g(path, f2, f3, f4, f5, f11 * sqrt, f7 * sqrt, f8, z2, z3);
                return;
            }
        ...
        public static void i(PathDataNode[] pathDataNodeArr, Path path) {
            PathParser.i(pathDataNodeArr, path);
        }

        public void h(PathDataNode pathDataNode, PathDataNode pathDataNode2, float f2) {
            this.f19781a = pathDataNode.f19781a;
            int i2 = 0;
            while (true) {
                float[] fArr = pathDataNode.f19782b;
                if (i2 < fArr.length) {
                    this.f19782b[i2] = (fArr[i2] * (1.0f - f2)) + (pathDataNode2.f19782b[i2] * f2);
                    i2++;
                } else {
                    return;
                }
        ...
        public PathDataNode(PathDataNode pathDataNode) {
            this.f19781a = pathDataNode.f19781a;
            float[] fArr = pathDataNode.f19782b;
            this.f19782b = PathParser.c(fArr, 0, fArr.length);
        }
    }
}
