...
public abstract class SharedElementCallback {
    ...
    public Parcelable b(View view, Matrix matrix, RectF rectF) {
        ...
        if (this.f19682a == null) {
            this.f19682a = new Matrix();
        }
        this.f19682a.set(matrix);
        this.f19682a.postTranslate(-rectF.left, -rectF.top);
        this.f19682a.postScale(min, min);
        Bitmap createBitmap = Bitmap.createBitmap(i2, i3, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        canvas.concat(this.f19682a);
        view.draw(canvas);
        return createBitmap;
    }
