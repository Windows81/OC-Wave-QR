...
public final class CancellationSignal {
    ...
    public OnCancelListener f19951b;
    ...
    public void a() {
        /*
            r3 = this;
            monitor-enter(r3)
            boolean r0 = r3.f19950a     // Catch:{ all -> 0x0007 }
        ...
        L_0x0009:
            r0 = 1
            r3.f19950a = r0     // Catch:{ all -> 0x0007 }
            r3.f19953d = r0     // Catch:{ all -> 0x0007 }
            androidx.core.os.CancellationSignal$OnCancelListener r0 = r3.f19951b     // Catch:{ all -> 0x0007 }
            java.lang.Object r1 = r3.f19952c     // Catch:{ all -> 0x0007 }
            monitor-exit(r3)     // Catch:{ all -> 0x0007 }
            r2 = 0
        ...
        L_0x0024:
            monitor-enter(r3)
            r3.f19953d = r2     // Catch:{ all -> 0x002c }
        ...
        L_0x002f:
            monitor-enter(r3)
            r3.f19953d = r2     // Catch:{ all -> 0x0037 }
        ...
        synchronized (this) {
            try {
                if (this.f19952c == null) {
                    ...
                    this.f19952c = cancellationSignal;
                    if (this.f19950a) {
    ...
    public void c(OnCancelListener onCancelListener) {
        synchronized (this) {
            try {
                d();
                if (this.f19951b != onCancelListener) {
                    this.f19951b = onCancelListener;
                    if (this.f19950a) {
