...
public final class ComplexColorCompat {
    ...
    public final Shader f19722a;

    /* renamed from: b  reason: collision with root package name */
    public final ColorStateList f19723b;
    ...
    public boolean i() {
        /*
            r1 = this;
            android.graphics.Shader r0 = r1.f19722a
            if (r0 != 0) goto L_0x0010
            android.content.res.ColorStateList r0 = r1.f19723b
            if (r0 == 0) goto L_0x0010
    ...
    public boolean j(int[] iArr) {
        if (i()) {
            ColorStateList colorStateList = this.f19723b;
            int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
            if (colorForState != this.f19724c) {
                this.f19724c = colorForState;
                return true;
            }
        }
        return false;
