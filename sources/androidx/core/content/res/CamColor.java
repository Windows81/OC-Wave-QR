...
public class CamColor {
    ...
    public static CamColor c(int i2) {
        ...
        d(i2, ViewingConditions.f19751k, fArr, fArr2);
    ...
    public static CamColor e(float f2, float f3, float f4) {
        return f(f2, f3, f4, ViewingConditions.f19751k);
    }
    ...
    public static int m(float f2, float f3, float f4) {
        return n(f2, f3, f4, ViewingConditions.f19751k);
    }
    ...
    public int o(ViewingConditions viewingConditions) {
        ...
        float[][] fArr = CamUtils.f19718b;
        float[] fArr2 = fArr[0];
        float f13 = (fArr2[0] * f10) + (fArr2[1] * f11) + (fArr2[2] * f12);
        float[] fArr3 = fArr[1];
        float[] fArr4 = fArr[2];
        return ColorUtils.a((double) f13, (double) ((fArr3[0] * f10) + (fArr3[1] * f11) + (fArr3[2] * f12)), (double) ((f10 * fArr4[0]) + (f11 * fArr4[1]) + (f12 * fArr4[2])));
    }

    public int p() {
        return o(ViewingConditions.f19751k);
    }
}
