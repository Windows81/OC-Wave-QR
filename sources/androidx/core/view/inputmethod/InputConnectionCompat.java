...
public final class InputConnectionCompat {
    ...
    public class AnonymousClass2 extends InputConnectionWrapper {
        ...
        public final /* synthetic */ OnCommitContentListener f20422a;

        public boolean performPrivateCommand(String str, Bundle bundle) {
            if (InputConnectionCompat.e(str, bundle, this.f20422a)) {
                return true;
            }
    ...
    public static /* synthetic */ boolean f(View view, InputContentInfoCompat inputContentInfoCompat, int i2, Bundle bundle) {
        ...
        return ViewCompat.N(view, new ContentInfoCompat.Builder(new ClipData(inputContentInfoCompat.b(), new ClipData.Item(inputContentInfoCompat.a())), 2).d(inputContentInfoCompat.c()).b(bundle).a()) == null;
    }
}
