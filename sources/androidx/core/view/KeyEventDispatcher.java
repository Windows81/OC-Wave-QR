...
public class KeyEventDispatcher {
    ...
    public static boolean f20223a = false;

    /* renamed from: b  reason: collision with root package name */
    public static Method f20224b = null;

    /* renamed from: c  reason: collision with root package name */
    public static boolean f20225c = false;

    /* renamed from: d  reason: collision with root package name */
    public static Field f20226d;
    ...
    public static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!f20223a) {
            try {
                f20224b = actionBar.getClass().getMethod("onMenuKeyEvent", new Class[]{KeyEvent.class});
            } catch (NoSuchMethodException unused) {
            }
            f20223a = true;
        }
        Method method = f20224b;
        if (method != null) {
            try {
    ...
    public static boolean e(Component component, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? component.w(keyEvent) : callback instanceof Activity ? b((Activity) callback, keyEvent) : callback instanceof Dialog ? c((Dialog) callback, keyEvent) : (view != null && ViewCompat.f(view, keyEvent)) || component.w(keyEvent);
    }
