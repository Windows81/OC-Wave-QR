...
public final class WrappedComposition$setContent$1$1$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WrappedComposition$setContent$1$1$2$1(WrappedComposition wrappedComposition, Continuation continuation) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((WrappedComposition$setContent$1$1$2$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new WrappedComposition$setContent$1$1$2$1(this.E, continuation);
    }
