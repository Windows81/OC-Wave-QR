...
public final class AndroidViewHolder$onNestedPreFling$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AndroidViewHolder$onNestedPreFling$1(AndroidViewHolder androidViewHolder, long j2, Continuation continuation) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AndroidViewHolder$onNestedPreFling$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new AndroidViewHolder$onNestedPreFling$1(this.E, this.F, continuation);
    }
    ...
    public final Object x(Object obj) {
        ...
        if (i2 == 0) {
            ResultKt.b(obj);
            NestedScrollDispatcher c2 = this.E.f19199A;
            long j2 = this.F;
            this.D = 1;
            if (c2.c(j2, this) == f2) {
                return f2;
