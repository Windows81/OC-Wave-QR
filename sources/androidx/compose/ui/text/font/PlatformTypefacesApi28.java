...
final class PlatformTypefacesApi28 implements PlatformTypefaces {
    public Typeface a(GenericFontFamily genericFontFamily, FontWeight fontWeight, int i2) {
        return d(genericFontFamily.n(), fontWeight, i2);
    }
    ...
    public final Typeface d(String str, FontWeight fontWeight, int i2) {
        ...
        if (FontStyle.f(i2, companion.b()) && Intrinsics.d(fontWeight, FontWeight.f18746A.g()) && (str == null || str.length() == 0)) {
            return Typeface.DEFAULT;
        }
        return Typeface.create(str == null ? Typeface.DEFAULT : Typeface.create(str, 0), fontWeight.y(), FontStyle.f(i2, companion.a()));
    }
    ...
    public final Typeface e(String str, FontWeight fontWeight, int i2) {
        ...
        if (Intrinsics.d(d2, TypefaceHelperMethodsApi28.f18765a.a(Typeface.DEFAULT, fontWeight.y(), FontStyle.f(i2, FontStyle.f18724b.a()))) || Intrinsics.d(d2, d((String) null, fontWeight, i2))) {
            return null;
        }
        return d2;
    }
