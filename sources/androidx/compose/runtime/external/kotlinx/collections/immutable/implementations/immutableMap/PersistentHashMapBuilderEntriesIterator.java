...
public final class PersistentHashMapBuilderEntriesIterator<K, V> implements Iterator<Map.Entry<K, V>>, KMutableIterator {
    ...
    public final PersistentHashMapBuilderBaseIterator f15050z;
    ...
    public PersistentHashMapBuilderEntriesIterator(PersistentHashMapBuilder persistentHashMapBuilder) {
        ...
        this.f15050z = new PersistentHashMapBuilderBaseIterator(persistentHashMapBuilder, trieNodeBaseIteratorArr);
    }

    /* renamed from: b */
    public Map.Entry next() {
        return (Map.Entry) this.f15050z.next();
    }

    public final void c(Object obj, Object obj2) {
        this.f15050z.m(obj, obj2);
    }

    public boolean hasNext() {
        return this.f15050z.hasNext();
    }
