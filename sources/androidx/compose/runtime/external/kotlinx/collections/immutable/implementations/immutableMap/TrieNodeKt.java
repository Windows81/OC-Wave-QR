...
public final class TrieNodeKt {
    ...
    public static final Object[] i(Object[] objArr, int i2) {
    ...
    public static final Object[] j(Object[] objArr, int i2, int i3, TrieNode trieNode) {
        Object[] objArr2 = new Object[(objArr.length - 1)];
        ArraysKt.q(objArr, objArr2, 0, 0, i2, 6, (Object) null);
    ...
    public static final Object[] k(Object[] objArr, int i2, int i3, Object obj, Object obj2) {
        Object[] copyOf = Arrays.copyOf(objArr, objArr.length + 1);
        Intrinsics.h(copyOf, "copyOf(...)");
        ArraysKt.l(copyOf, copyOf, i2 + 2, i2 + 1, objArr.length);
        ArraysKt.l(copyOf, copyOf, i3 + 2, i3, i2);
        copyOf[i3] = obj;
        copyOf[i3 + 1] = obj2;
        return copyOf;
    }
