...
public final class AbstractClickableNode$onFocusChange$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AbstractClickableNode$onFocusChange$1$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new AbstractClickableNode$onFocusChange$1$1(this.E, this.F, continuation);
    }
    ...
    public final Object x(Object obj) {
        ...
        if (i2 == 0) {
            ...
            if (i3 != null) {
                PressInteraction.Cancel cancel = new PressInteraction.Cancel(this.F);
                this.D = 1;
                if (i3.a(cancel, this) == f2) {
                    return f2;
                }
            }
        } else if (i2 == 1) {
