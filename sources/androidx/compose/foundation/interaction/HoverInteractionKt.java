...
public final class HoverInteractionKt {
    public static final State a(InteractionSource interactionSource, Composer composer, int i2) {
        if (ComposerKt.P()) {
            ComposerKt.Y(1206586544, i2, -1, "androidx.compose.foundation.interaction.collectIsHoveredAsState (HoverInteraction.kt:63)");
        }
        ...
        if (z2 || g3 == companion.a()) {
            g3 = new HoverInteractionKt$collectIsHoveredAsState$1$1(interactionSource, mutableState, (Continuation) null);
            composer.N(g3);
        }
