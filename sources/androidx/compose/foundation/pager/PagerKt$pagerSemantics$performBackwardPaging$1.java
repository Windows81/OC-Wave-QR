...
public final class PagerKt$pagerSemantics$performBackwardPaging$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((PagerKt$pagerSemantics$performBackwardPaging$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new PagerKt$pagerSemantics$performBackwardPaging$1(this.E, continuation);
    }
    ...
    public final Object x(Object obj) {
        ...
        if (i2 == 0) {
            ...
            this.D = 1;
            if (PagerStateKt.f(pagerState, this) == f2) {
                return f2;
            }
        } else if (i2 == 1) {
            ResultKt.b(obj);
