...
public final class PagerSemanticsKt {
    public static final LazyLayoutSemanticState a(PagerState pagerState, boolean z2, Composer composer, int i2) {
        if (ComposerKt.P()) {
            ComposerKt.Y(-786344289, i2, -1, "androidx.compose.foundation.pager.rememberPagerSemanticState (PagerSemantics.kt:26)");
        }
        boolean z3 = false;
        boolean z4 = (((i2 & 14) ^ 6) > 4 && composer.W(pagerState)) || (i2 & 6) == 4;
        ...
        if (z5 || g2 == Composer.f14567a.a()) {
            g2 = LazyLayoutSemanticStateKt.a(pagerState, z2);
            composer.N(g2);
        }
