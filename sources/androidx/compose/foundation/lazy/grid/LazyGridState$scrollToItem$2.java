...
public final class LazyGridState$scrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object m(ScrollScope scrollScope, Continuation continuation) {
        return ((LazyGridState$scrollToItem$2) s(scrollScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new LazyGridState$scrollToItem$2(this.E, this.F, this.G, continuation);
    }
