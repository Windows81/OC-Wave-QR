...
public final class LazyStaggeredGridDslKt$itemsIndexed$5 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function5 f5034z;
    ...
    public final void b(LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i2, Composer composer, int i3) {
        ...
        if (composer.E((i4 & 147) != 146, i4 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(284833944, i4, -1, "androidx.compose.foundation.lazy.staggeredgrid.itemsIndexed.<anonymous> (LazyStaggeredGridDsl.kt:444)");
            }
            this.f5034z.n(lazyStaggeredGridItemScope, Integer.valueOf(i2), this.f5033A.get(i2), composer, Integer.valueOf(i4 & 126));
            if (ComposerKt.P()) {
                ComposerKt.X();
                return;
            }
