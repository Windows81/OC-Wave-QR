...
public final class LazyStaggeredGridState$scrollToItem$2 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
    ...
    public LazyStaggeredGridState$scrollToItem$2(LazyStaggeredGridState lazyStaggeredGridState, int i2, int i3, Continuation continuation) {
    ...
    public final Object m(ScrollScope scrollScope, Continuation continuation) {
        return ((LazyStaggeredGridState$scrollToItem$2) s(scrollScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new LazyStaggeredGridState$scrollToItem$2(this.E, this.F, this.G, continuation);
    }
