...
public final class LazyStaggeredGridDslKt$itemsIndexed$10 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Object[] f5025A;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ Function5 f5026z;
    ...
    public final void b(LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i2, Composer composer, int i3) {
        ...
        if (composer.E((i4 & 147) != 146, i4 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-804487775, i4, -1, "androidx.compose.foundation.lazy.staggeredgrid.itemsIndexed.<anonymous> (LazyStaggeredGridDsl.kt:516)");
            }
            this.f5026z.n(lazyStaggeredGridItemScope, Integer.valueOf(i2), this.f5025A[i2], composer, Integer.valueOf(i4 & 126));
            if (ComposerKt.P()) {
                ComposerKt.X();
                return;
            }
