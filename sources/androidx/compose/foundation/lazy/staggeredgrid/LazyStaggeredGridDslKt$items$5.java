...
public final class LazyStaggeredGridDslKt$items$5 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ List f5015A;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ Function4 f5016z;
    ...
    public final void b(LazyStaggeredGridItemScope lazyStaggeredGridItemScope, int i2, Composer composer, int i3) {
        ...
        if (composer.E((i4 & 147) != 146, i4 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-886456479, i4, -1, "androidx.compose.foundation.lazy.staggeredgrid.items.<anonymous> (LazyStaggeredGridDsl.kt:408)");
            }
            this.f5016z.j(lazyStaggeredGridItemScope, this.f5015A.get(i2), composer, Integer.valueOf(i4 & 14));
            if (ComposerKt.P()) {
                ComposerKt.X();
                return;
            }
