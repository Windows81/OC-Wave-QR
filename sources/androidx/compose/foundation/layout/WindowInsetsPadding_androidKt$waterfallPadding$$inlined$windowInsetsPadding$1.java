...
@Metadata
public final class WindowInsetsPadding_androidKt$waterfallPadding$$inlined$windowInsetsPadding$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    public final Modifier b(Modifier modifier, Composer composer, int i2) {
        ...
        if (W || g2 == Composer.f14567a.a()) {
            g2 = new InsetsPaddingModifier(c2.o());
            composer.N(g2);
        }
