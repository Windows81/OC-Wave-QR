...
public final class SelectableKt$selectableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final /* synthetic */ boolean f5415B;
    public final /* synthetic */ Role C;
    public final /* synthetic */ Function0 D;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ Indication f5416z;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SelectableKt$selectableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1(Indication indication, boolean z2, boolean z3, Role role, Function0 function0) {
        super(3);
        this.f5416z = indication;
        this.f5414A = z2;
        this.f5415B = z3;
        this.C = role;
        this.D = function0;
    ...
    public final Modifier b(Modifier modifier, Composer composer, int i2) {
        ...
        Modifier o0 = IndicationKt.b(Modifier.f15489d, mutableInteractionSource, this.f5416z).o0(new SelectableElement(this.f5414A, mutableInteractionSource, (IndicationNodeFactory) null, this.f5415B, this.C, this.D, (DefaultConstructorMarker) null));
        if (ComposerKt.P()) {
            ComposerKt.X();
        }
        composer.M();
