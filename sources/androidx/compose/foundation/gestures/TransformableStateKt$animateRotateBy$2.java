...
@Metadata
@DebugMetadata(c = "androidx.compose.foundation.gestures.TransformableStateKt$animateRotateBy$2", f = "TransformableState.kt", l = {162}, m = "invokeSuspend")
final class TransformableStateKt$animateRotateBy$2 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public TransformableStateKt$animateRotateBy$2(Ref.FloatRef floatRef, float f2, AnimationSpec animationSpec, Continuation continuation) {
    ...
    public final Object m(TransformScope transformScope, Continuation continuation) {
        return ((TransformableStateKt$animateRotateBy$2) s(transformScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        TransformableStateKt$animateRotateBy$2 transformableStateKt$animateRotateBy$2 = new TransformableStateKt$animateRotateBy$2(this.F, this.G, this.H, continuation);
        transformableStateKt$animateRotateBy$2.E = obj;
        ...
        if (i2 == 0) {
            ...
            AnonymousClass1 r5 = new Function1<AnimationScope<Float, AnimationVector1D>, Unit>() {
                public final void b(AnimationScope animationScope) {
                    TransformScope.b(transformScope, 0.0f, 0, ((Number) animationScope.e()).floatValue() - floatRef.f40905z, 3, (Object) null);
