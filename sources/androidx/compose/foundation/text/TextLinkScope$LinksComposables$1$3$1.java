...
public final class TextLinkScope$LinksComposables$1$3$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int D;
    public final /* synthetic */ LinkStateInteractionSourceObserver E;
    ...
    public TextLinkScope$LinksComposables$1$3$1(LinkStateInteractionSourceObserver linkStateInteractionSourceObserver, Continuation continuation) {
        ...
        this.E = linkStateInteractionSourceObserver;
    }

    /* renamed from: A */
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((TextLinkScope$LinksComposables$1$3$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new TextLinkScope$LinksComposables$1$3$1(this.E, continuation);
    }
    ...
    public final Object x(Object obj) {
        ...
        if (i2 == 0) {
            ResultKt.b(obj);
            LinkStateInteractionSourceObserver linkStateInteractionSourceObserver = this.E;
            this.D = 1;
            if (linkStateInteractionSourceObserver.e(this) == f2) {
                return f2;
            }
        } else if (i2 == 1) {
            ResultKt.b(obj);
