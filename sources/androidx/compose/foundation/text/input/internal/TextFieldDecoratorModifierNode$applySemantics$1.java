...
public final class TextFieldDecoratorModifierNode$applySemantics$1 extends Lambda implements Function1<AnnotatedString, Boolean> {
    ...
    public final /* synthetic */ TextFieldDecoratorModifierNode f6304A;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ boolean f6305z;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object x(Object obj) {
            ...
            if (i2 == 0) {
                ...
                this.D = 1;
                if (textFieldDecoratorModifierNode.E3(this) == f2) {
                    return f2;
                }
            } else if (i2 == 1) {
                ResultKt.b(obj);
    ...
    public TextFieldDecoratorModifierNode$applySemantics$1(boolean z2, TextFieldDecoratorModifierNode textFieldDecoratorModifierNode) {
        super(1);
        this.f6305z = z2;
        this.f6304A = textFieldDecoratorModifierNode;
    }
    ...
    public final Boolean invoke(AnnotatedString annotatedString) {
        ...
        this.f6304A.B3().v(annotatedString);
        this.f6304A.I3(true);
        CoroutineScope y2 = this.f6304A.y2();
        final TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = this.f6304A;
