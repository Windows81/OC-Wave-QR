...
public final class TextFieldDecoratorModifierNode$applySemantics$9 extends Lambda implements Function0<Boolean> {
    ...
    public final /* synthetic */ TextFieldDecoratorModifierNode f6318z;
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object x(Object obj) {
            ...
            if (i2 == 0) {
                ...
                this.D = 1;
                if (TextFieldSelectionState.I(A3, false, this, 1, (Object) null) == f2) {
                    return f2;
                }
            } else if (i2 == 1) {
                ResultKt.b(obj);
    ...
    public TextFieldDecoratorModifierNode$applySemantics$9(TextFieldDecoratorModifierNode textFieldDecoratorModifierNode) {
        super(0);
        this.f6318z = textFieldDecoratorModifierNode;
    }

    /* renamed from: b */
    public final Boolean invoke() {
        CoroutineScope y2 = this.f6318z.y2();
        final TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = this.f6318z;
