...
public final class ComposableSingletons$BasicTextFieldKt$lambda1$1 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public static final ComposableSingletons$BasicTextFieldKt$lambda1$1 f5635z = new ComposableSingletons$BasicTextFieldKt$lambda1$1();
    ...
    public final void b(Function2 function2, Composer composer, int i2) {
        ...
        if (composer.E((i2 & 19) != 18, i2 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(997835932, i2, -1, "androidx.compose.foundation.text.ComposableSingletons$BasicTextFieldKt.lambda-1.<anonymous> (BasicTextField.kt:708)");
            }
