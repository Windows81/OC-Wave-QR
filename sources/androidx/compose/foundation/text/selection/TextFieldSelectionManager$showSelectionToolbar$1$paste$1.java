...
@Metadata
public final class TextFieldSelectionManager$showSelectionToolbar$1$paste$1 extends Lambda implements Function0<Unit> {

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ TextFieldSelectionManager f7002z;
    ...
    public TextFieldSelectionManager$showSelectionToolbar$1$paste$1(TextFieldSelectionManager textFieldSelectionManager) {
        super(0);
        this.f7002z = textFieldSelectionManager;
    }

    public final void invoke() {
        CoroutineScope C = this.f7002z.C();
        if (C != null) {
            CoroutineStart coroutineStart = CoroutineStart.UNDISPATCHED;
            final TextFieldSelectionManager textFieldSelectionManager = this.f7002z;
