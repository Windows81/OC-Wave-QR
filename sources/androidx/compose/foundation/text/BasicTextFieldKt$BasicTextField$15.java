...
public final class BasicTextFieldKt$BasicTextField$15 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function1 f5532A;

    /* renamed from: B  reason: collision with root package name */
    public final /* synthetic */ Modifier f5533B;
    ...
    public final void b(Composer composer, int i2) {
        ...
        String str = this.f5534z;
        String str2 = str;
        BasicTextFieldKt.f(str2, this.f5532A, this.f5533B, this.C, this.D, this.E, this.F, this.G, this.H, this.I, this.J, this.K, this.L, this.M, this.N, composer2, RecomposeScopeImplKt.a(this.O | 1), RecomposeScopeImplKt.a(this.P), this.Q);
    }
