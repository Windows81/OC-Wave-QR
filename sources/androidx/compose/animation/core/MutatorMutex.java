...
public final class MutatorMutex {
    ...
    public final AtomicReference f2626a = new AtomicReference((Object) null);

    /* renamed from: b  reason: collision with root package name */
    public final Mutex f2627b = MutexKt.b(false, 1, (Object) null);

    @Metadata
    public static final class Mutator {

        /* renamed from: a  reason: collision with root package name */
        public final MutatePriority f2628a;

        /* renamed from: b  reason: collision with root package name */
        public final Job f2629b;

        public Mutator(MutatePriority mutatePriority, Job job) {
            this.f2628a = mutatePriority;
            this.f2629b = job;
        }

        public final boolean a(Mutator mutator) {
            return this.f2628a.compareTo(mutator.f2628a) >= 0;
        }

        public final void b() {
            this.f2629b.c(new MutationInterruptedException());
        }
    }
    ...
    public final void f(Mutator mutator) {
        Mutator mutator2;
        do {
            mutator2 = (Mutator) this.f2626a.get();
            if (mutator2 != null && !mutator.a(mutator2)) {
                throw new CancellationException("Current mutation had a higher priority");
            }
        } while (!h.a(this.f2626a, mutator2, mutator));
        if (mutator2 != null) {
            mutator2.b();
        }
    }
