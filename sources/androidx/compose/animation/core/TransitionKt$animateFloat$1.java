...
public final class TransitionKt$animateFloat$1 extends Lambda implements Function3<Transition.Segment<Object>, Composer, Integer, SpringSpec<Float>> {
    ...
    public static final TransitionKt$animateFloat$1 f2761z = new TransitionKt$animateFloat$1();
    ...
    public final SpringSpec b(Transition.Segment segment, Composer composer, int i2) {
        ...
        if (ComposerKt.P()) {
            ComposerKt.Y(-522164544, i2, -1, "androidx.compose.animation.core.animateFloat.<anonymous> (Transition.kt:1920)");
        }
