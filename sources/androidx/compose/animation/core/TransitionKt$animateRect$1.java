...
public final class TransitionKt$animateRect$1 extends Lambda implements Function3<Transition.Segment<Object>, Composer, Integer, SpringSpec<Rect>> {
    ...
    public static final TransitionKt$animateRect$1 f2766z = new TransitionKt$animateRect$1();
    ...
    public final SpringSpec b(Transition.Segment segment, Composer composer, int i2) {
        composer.X(691336298);
        if (ComposerKt.P()) {
            ComposerKt.Y(691336298, i2, -1, "androidx.compose.animation.core.animateRect.<anonymous> (Transition.kt:2135)");
        }
        SpringSpec l2 = AnimationSpecKt.l(0.0f, 0.0f, VisibilityThresholdsKt.g(Rect.f15860e), 3, (Object) null);
        if (ComposerKt.P()) {
            ComposerKt.X();
        }
        composer.M();
