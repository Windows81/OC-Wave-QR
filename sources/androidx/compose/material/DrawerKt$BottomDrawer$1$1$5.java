...
public final class DrawerKt$BottomDrawer$1$1$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function3 f7729z;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DrawerKt$BottomDrawer$1$1$5(Function3 function3) {
        super(2);
        this.f7729z = function3;
    }

    public final void b(Composer composer, int i2) {
        if (composer.E((i2 & 3) != 2, i2 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(457750254, i2, -1, "androidx.compose.material.BottomDrawer.<anonymous>.<anonymous>.<anonymous> (Drawer.kt:691)");
            }
            Function3 function3 = this.f7729z;
