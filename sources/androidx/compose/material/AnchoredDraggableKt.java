...
public final class AnchoredDraggableKt {
    ...
    public static final Modifier d(Modifier modifier, AnchoredDraggableState anchoredDraggableState, Orientation orientation, boolean z2, boolean z3, MutableInteractionSource mutableInteractionSource, boolean z4) {
        AnchoredDraggableState anchoredDraggableState2 = anchoredDraggableState;
        return DraggableKt.h(modifier, anchoredDraggableState.u(), orientation, z2, mutableInteractionSource, z4, (Function3) null, new AnchoredDraggableKt$anchoredDraggable$1(anchoredDraggableState, (Continuation) null), z3, 32, (Object) null);
    }

    public static /* synthetic */ Modifier e(Modifier modifier, AnchoredDraggableState anchoredDraggableState, Orientation orientation, boolean z2, boolean z3, MutableInteractionSource mutableInteractionSource, boolean z4, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            z2 = true;
        }
        boolean z5 = z2;
        ...
        if ((i2 & 32) != 0) {
            z4 = anchoredDraggableState.y();
        }
        return d(modifier, anchoredDraggableState, orientation, z5, z6, mutableInteractionSource2, z4);
    }
    ...
    public static /* synthetic */ Object g(AnchoredDraggableState anchoredDraggableState, Object obj, float f2, Continuation continuation, int i2, Object obj2) {
        if ((i2 & 2) != 0) {
            f2 = anchoredDraggableState.v();
        }
        return f(anchoredDraggableState, obj, f2, continuation);
    }

    public static final Modifier h(Modifier modifier, AnchoredDraggableState anchoredDraggableState, Orientation orientation, Function2 function2) {
    ...
    public static final java.lang.Object j(kotlin.jvm.functions.Function0 r4, kotlin.jvm.functions.Function2 r5, kotlin.coroutines.Continuation r6) {
        ...
        L_0x0031:
            ...
            androidx.compose.material.AnchoredDraggableKt$restartable$2 r6 = new androidx.compose.material.AnchoredDraggableKt$restartable$2     // Catch:{ AnchoredDragFinishedSignal -> 0x0043 }
            r2 = 0
        ...
        L_0x0043:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.AnchoredDraggableKt.j(kotlin.jvm.functions.Function0, kotlin.jvm.functions.Function2, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
