...
public final class AnchoredDraggableState$progress$2 extends Lambda implements Function0<Float> {
    ...
    public final /* synthetic */ AnchoredDraggableState f7114z;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnchoredDraggableState$progress$2(AnchoredDraggableState anchoredDraggableState) {
        super(0);
        this.f7114z = anchoredDraggableState;
    }

    /* renamed from: b */
    public final Float invoke() {
        float c2 = this.f7114z.o().c(this.f7114z.s());
        float c3 = this.f7114z.o().c(this.f7114z.q()) - c2;
        float abs = Math.abs(c3);
        float f2 = 1.0f;
        if (!Float.isNaN(abs) && abs > 1.0E-6f) {
            float A2 = (this.f7114z.A() - c2) / c3;
            if (A2 < 1.0E-6f) {
                f2 = 0.0f;
