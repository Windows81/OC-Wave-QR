...
public final class TextFieldTransitionScope$Transition$labelProgress$2 extends Lambda implements Function3<Transition.Segment<InputPhase>, Composer, Integer, FiniteAnimationSpec<Float>> {
    ...
    public static final TextFieldTransitionScope$Transition$labelProgress$2 f8855z = new TextFieldTransitionScope$Transition$labelProgress$2();
    ...
    public final FiniteAnimationSpec b(Transition.Segment segment, Composer composer, int i2) {
        composer.X(-611722692);
        if (ComposerKt.P()) {
            ComposerKt.Y(-611722692, i2, -1, "androidx.compose.material.TextFieldTransitionScope.Transition.<anonymous> (TextFieldImpl.kt:292)");
        }
