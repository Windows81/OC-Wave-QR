...
public final class TextFieldTransitionScope$Transition$labelTextStyleColor$2 extends Lambda implements Function3<Transition.Segment<InputPhase>, Composer, Integer, FiniteAnimationSpec<Color>> {
    ...
    public static final TextFieldTransitionScope$Transition$labelTextStyleColor$2 f8856z = new TextFieldTransitionScope$Transition$labelTextStyleColor$2();
    ...
    public final FiniteAnimationSpec b(Transition.Segment segment, Composer composer, int i2) {
        composer.X(-130058045);
        if (ComposerKt.P()) {
            ComposerKt.Y(-130058045, i2, -1, "androidx.compose.material.TextFieldTransitionScope.Transition.<anonymous> (TextFieldImpl.kt:333)");
        }
