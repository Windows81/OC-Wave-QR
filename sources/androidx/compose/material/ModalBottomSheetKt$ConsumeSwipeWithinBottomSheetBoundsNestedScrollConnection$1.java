...
public final class ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public final /* synthetic */ Orientation f7989A;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ AnchoredDraggableState f7990z;
    ...
    public ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1(AnchoredDraggableState anchoredDraggableState, Orientation orientation) {
        this.f7990z = anchoredDraggableState;
        this.f7989A = orientation;
    }

    private final float a(long j2) {
        return this.f7989A == Orientation.Horizontal ? Offset.m(j2) : Offset.n(j2);
    }

    private final long b(float f2) {
        Orientation orientation = this.f7989A;
    ...
    private final float c(long j2) {
        return this.f7989A == Orientation.Horizontal ? Velocity.h(j2) : Velocity.i(j2);
    }
    ...
    public java.lang.Object H1(long r6, kotlin.coroutines.Continuation r8) {
        ...
        L_0x0033:
            kotlin.ResultKt.b(r8)
            float r8 = r5.c(r6)
            androidx.compose.material.AnchoredDraggableState r2 = r5.f7990z
            float r2 = r2.A()
            r4 = 0
            int r4 = (r8 > r4 ? 1 : (r8 == r4 ? 0 : -1))
            if (r4 >= 0) goto L_0x0060
            androidx.compose.material.AnchoredDraggableState r4 = r5.f7990z
        ...
        L_0x0066:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.H1(long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public long c2(long j2, long j3, int i2) {
        return NestedScrollSource.e(i2, NestedScrollSource.f16795b.b()) ? b(this.f7990z.n(a(j3))) : Offset.f15855b.c();
    }
    ...
    public java.lang.Object q0(long r3, long r5, kotlin.coroutines.Continuation r7) {
        ...
        L_0x0033:
            kotlin.ResultKt.b(r4)
            androidx.compose.material.AnchoredDraggableState r4 = r2.f7990z
            float r0 = r2.c(r5)
            r3.C = r5
            r3.F = r1
        ...
        L_0x0047:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ModalBottomSheetKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1.q0(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public long t1(long j2, int i2) {
        float a2 = a(j2);
        return (a2 >= 0.0f || !NestedScrollSource.e(i2, NestedScrollSource.f16795b.b())) ? Offset.f15855b.c() : b(this.f7990z.n(a2));
    }
}
