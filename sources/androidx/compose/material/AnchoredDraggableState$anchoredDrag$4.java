    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Pair<? extends DraggableAnchors<T>, ? extends T>, Continuation<? super Unit>, Object> {
        ...
        public final Object x(Object obj) {
            ...
            if (i2 == 0) {
                ...
                AnchoredDragScope c2 = anchoredDraggableState2.f7100o;
                this.D = 1;
                if (function4.j(c2, (DraggableAnchors) pair.a(), b2, this) == f2) {
                    return f2;
                }
            } else if (i2 == 1) {
                ResultKt.b(obj);
        ...
        if (i2 == 0) {
            ...
            AnonymousClass1 r7 = new Function0<Pair<? extends DraggableAnchors<T>, ? extends T>>() {
                ...
                public final Pair invoke() {
                    return TuplesKt.a(anchoredDraggableState.o(), anchoredDraggableState.x());
                }
            };
            ...
            this.D = 1;
            if (AnchoredDraggableKt.j(r7, r1, this) == f2) {
                return f2;
            }
        } else if (i2 == 1) {
            ResultKt.b(obj);
