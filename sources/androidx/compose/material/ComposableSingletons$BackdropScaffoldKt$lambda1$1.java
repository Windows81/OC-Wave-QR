...
public final class ComposableSingletons$BackdropScaffoldKt$lambda1$1 extends Lambda implements Function3<SnackbarHostState, Composer, Integer, Unit> {
    ...
    public static final ComposableSingletons$BackdropScaffoldKt$lambda1$1 f7528z = new ComposableSingletons$BackdropScaffoldKt$lambda1$1();
    ...
    public final void b(SnackbarHostState snackbarHostState, Composer composer, int i2) {
        ...
        if (composer.E((i2 & 19) != 18, i2 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-1054097158, i2, -1, "androidx.compose.material.ComposableSingletons$BackdropScaffoldKt.lambda-1.<anonymous> (BackdropScaffold.kt:351)");
            }
