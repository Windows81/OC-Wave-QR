...
public final class TextFieldKt$TextField$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function1 f8826A;

    /* renamed from: B  reason: collision with root package name */
    public final /* synthetic */ Modifier f8827B;
    ...
    public final void b(Composer composer, int i2) {
        ...
        String str = this.f8828z;
        String str2 = str;
        TextFieldKt.e(str2, this.f8826A, this.f8827B, this.C, this.D, this.E, this.F, this.G, this.H, this.I, this.J, this.K, this.L, this.M, this.N, this.O, this.P, this.Q, this.R, composer2, RecomposeScopeImplKt.a(this.S | 1), RecomposeScopeImplKt.a(this.T), this.U);
    }
