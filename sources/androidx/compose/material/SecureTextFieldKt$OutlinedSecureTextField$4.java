...
@Metadata
public final class SecureTextFieldKt$OutlinedSecureTextField$4 extends Lambda implements Function2<Composer, Integer, Unit> {

    /* renamed from: A  reason: collision with root package name */
    public final /* synthetic */ Modifier f8312A;
    ...
    public final void b(Composer composer, int i2) {
        ...
        TextFieldState textFieldState = this.f8314z;
        TextFieldState textFieldState2 = textFieldState;
        SecureTextFieldKt.a(textFieldState2, this.f8312A, this.f8313B, this.C, this.D, this.E, this.F, this.G, this.H, this.I, this.J, this.K, this.L, this.M, this.N, this.O, this.P, composer2, RecomposeScopeImplKt.a(this.Q | 1), RecomposeScopeImplKt.a(this.R), this.S);
    }
