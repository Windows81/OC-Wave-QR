...
@Metadata
public final class OutlinedTextFieldKt$OutlinedTextField$13 extends Lambda implements Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit> {
    ...
    public final /* synthetic */ TextFieldValue f8106z;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OutlinedTextFieldKt$OutlinedTextField$13(TextFieldValue textFieldValue, boolean z2, boolean z3, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, boolean z4, Function2 function2, Function2 function22, Function2 function23, Function2 function24, Shape shape, TextFieldColors textFieldColors) {
        super(3);
        this.f8106z = textFieldValue;
        this.f8104A = z2;
        this.f8105B = z3;
    ...
    public final void b(Function2 function2, Composer composer, int i2) {
        ...
        if (composer2.E((i3 & 19) != 18, i3 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-1001528775, i3, -1, "androidx.compose.material.OutlinedTextField.<anonymous> (OutlinedTextField.kt:591)");
            }
            TextFieldDefaults textFieldDefaults = TextFieldDefaults.f8730a;
            String i4 = this.f8106z.i();
            boolean z2 = this.f8104A;
            boolean z3 = z2;
            boolean z4 = this.f8105B;
            ...
            String str = i4;
            textFieldDefaults2.c(str, function2, z3, z4, visualTransformation, mutableInteractionSource2, z6, function23, function24, function25, function26, shape, textFieldColors, (PaddingValues) null, ComposableLambdaKt.e(-794566495, true, new Function2<Composer, Integer, Unit>() {
                public final void b(Composer composer, int i2) {
                    int i3 = i2;
                    if (composer.E((i3 & 3) != 2, i3 & 1)) {
                        if (ComposerKt.P()) {
                            ComposerKt.Y(-794566495, i3, -1, "androidx.compose.material.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:606)");
                        }
