...
@Metadata
public final class ModalBottomSheetKt$ModalBottomSheetLayout$1$1$1$1 extends Lambda implements Function0<Unit> {

    /* renamed from: A  reason: collision with root package name */
    public final /* synthetic */ CoroutineScope f7991A;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ ModalBottomSheetState f7992z;
    ...
    public ModalBottomSheetKt$ModalBottomSheetLayout$1$1$1$1(ModalBottomSheetState modalBottomSheetState, CoroutineScope coroutineScope) {
        super(0);
        this.f7992z = modalBottomSheetState;
        this.f7991A = coroutineScope;
    }

    public final void invoke() {
        if (((Boolean) this.f7992z.d().r().invoke(ModalBottomSheetValue.Hidden)).booleanValue()) {
            CoroutineScope coroutineScope = this.f7991A;
            final ModalBottomSheetState modalBottomSheetState = this.f7992z;
