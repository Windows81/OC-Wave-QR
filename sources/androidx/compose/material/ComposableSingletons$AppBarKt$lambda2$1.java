...
public final class ComposableSingletons$AppBarKt$lambda2$1 extends Lambda implements Function3<RowScope, Composer, Integer, Unit> {
    ...
    public static final ComposableSingletons$AppBarKt$lambda2$1 f7525z = new ComposableSingletons$AppBarKt$lambda2$1();
    ...
    public final void b(RowScope rowScope, Composer composer, int i2) {
        if (composer.E((i2 & 17) != 16, i2 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-771938130, i2, -1, "androidx.compose.material.ComposableSingletons$AppBarKt.lambda-2.<anonymous> (AppBar.kt:166)");
            }
            if (ComposerKt.P()) {
                ComposerKt.X();
                return;
