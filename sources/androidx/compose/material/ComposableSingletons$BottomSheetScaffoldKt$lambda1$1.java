...
public final class ComposableSingletons$BottomSheetScaffoldKt$lambda1$1 extends Lambda implements Function3<SnackbarHostState, Composer, Integer, Unit> {
    ...
    public static final ComposableSingletons$BottomSheetScaffoldKt$lambda1$1 f7533z = new ComposableSingletons$BottomSheetScaffoldKt$lambda1$1();
    ...
    public final void b(SnackbarHostState snackbarHostState, Composer composer, int i2) {
        ...
        if (composer.E((i2 & 19) != 18, i2 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(239945703, i2, -1, "androidx.compose.material.ComposableSingletons$BottomSheetScaffoldKt.lambda-1.<anonymous> (BottomSheetScaffold.kt:324)");
            }
