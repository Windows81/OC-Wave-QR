...
@Metadata
public final class BackdropScaffoldKt$BackLayerTransition$1$1$1 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ State f7193z;
    ...
    public final MeasureResult b(MeasureScope measureScope, Measurable measurable, long j2) {
        final float j3 = BackdropScaffoldKt.b(this.f7193z) - ((float) 1);
        if (j3 < 0.0f) {
            j3 = 0.0f;
        }
        if (j3 > 1.0f) {
