...
public final class TextFieldKt$TextField$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Modifier f8815B;
    ...
    public final void b(Composer composer, int i2) {
        ...
        TextFieldValue textFieldValue = this.f8816z;
        TextFieldValue textFieldValue2 = textFieldValue;
        TextFieldKt.c(textFieldValue2, this.f8814A, this.f8815B, this.C, this.D, this.E, this.F, this.G, this.H, this.I, this.J, this.K, this.L, this.M, this.N, this.O, this.P, this.Q, this.R, composer2, RecomposeScopeImplKt.a(this.S | 1), RecomposeScopeImplKt.a(this.T), this.U);
    }
