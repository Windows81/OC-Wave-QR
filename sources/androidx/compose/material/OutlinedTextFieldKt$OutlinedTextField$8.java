...
public final class OutlinedTextFieldKt$OutlinedTextField$8 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function1 f8141A;

    /* renamed from: B  reason: collision with root package name */
    public final /* synthetic */ Modifier f8142B;
    ...
    public final void b(Composer composer, int i2) {
        ...
        String str = this.f8143z;
        String str2 = str;
        OutlinedTextFieldKt.d(str2, this.f8141A, this.f8142B, this.C, this.D, this.E, this.F, this.G, this.H, this.I, this.J, this.K, this.L, this.M, this.N, this.O, this.P, this.Q, this.R, this.S, composer2, RecomposeScopeImplKt.a(this.T | 1), RecomposeScopeImplKt.a(this.U), this.V);
    }
