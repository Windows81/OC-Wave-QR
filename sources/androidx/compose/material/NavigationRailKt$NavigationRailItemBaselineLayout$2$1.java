...
@Metadata
public final class NavigationRailKt$NavigationRailItemBaselineLayout$2$1 implements MeasurePolicy {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ Function2 f8066a;

    /* renamed from: b  reason: collision with root package name */
    public final /* synthetic */ float f8067b;

    public NavigationRailKt$NavigationRailItemBaselineLayout$2$1(Function2 function2, float f2) {
        this.f8066a = function2;
        this.f8067b = f2;
    }
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (Intrinsics.d(LayoutIdKt.a(measurable), "icon")) {
                ...
                if (this.f8066a == null) {
                    ...
                    return NavigationRailKt.n(measureScope, c0, j3);
                }
                MeasureScope measureScope3 = measureScope;
                Intrinsics.f(placeable2);
                return NavigationRailKt.o(measureScope, placeable2, c0, j2, this.f8067b);
            }
