...
public final class OutlinedTextFieldKt$OutlinedTextField$10 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Modifier f8101B;
    ...
    public final void b(Composer composer, int i2) {
        ...
        String str = this.f8102z;
        String str2 = str;
        OutlinedTextFieldKt.e(str2, this.f8100A, this.f8101B, this.C, this.D, this.E, this.F, this.G, this.H, this.I, this.J, this.K, this.L, this.M, this.N, this.O, this.P, this.Q, this.R, composer2, RecomposeScopeImplKt.a(this.S | 1), RecomposeScopeImplKt.a(this.T), this.U);
    }
