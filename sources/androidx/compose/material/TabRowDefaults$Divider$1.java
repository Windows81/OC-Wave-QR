...
public final class TabRowDefaults$Divider$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Modifier f8687A;
    ...
    public final /* synthetic */ TabRowDefaults f8689z;
    ...
    public TabRowDefaults$Divider$1(TabRowDefaults tabRowDefaults, Modifier modifier, float f2, long j2, int i2, int i3) {
        super(2);
        this.f8689z = tabRowDefaults;
        this.f8687A = modifier;
        this.f8688B = f2;
        this.C = j2;
        this.D = i2;
        this.E = i3;
    ...
    public final void b(Composer composer, int i2) {
        this.f8689z.a(this.f8687A, this.f8688B, this.C, composer, RecomposeScopeImplKt.a(this.D | 1), this.E);
    }
