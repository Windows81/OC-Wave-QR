...
@Metadata
final class DefaultTwoRowsTopAppBarOverride$TwoRowsTopAppBar$actionsRow$1 implements Function2<Composer, Integer, Unit> {

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ TwoRowsTopAppBarOverrideScope f9851z;

    public final void b(Composer composer, int i2) {
        if (composer.E((i2 & 3) != 2, i2 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-1333673671, i2, -1, "androidx.compose.material3.DefaultTwoRowsTopAppBarOverride.TwoRowsTopAppBar.<anonymous> (AppBar.kt:2755)");
            }
            Arrangement.Horizontal c2 = Arrangement.f3739a.c();
            Alignment.Vertical i3 = Alignment.f15444a.i();
            Function3 a2 = this.f9851z.a();
