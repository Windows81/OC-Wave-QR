...
public final class OutlinedTextFieldKt$OutlinedTextField$3 implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ Function2 f10569A;
    ...
    public final /* synthetic */ Modifier f10571z;

    public OutlinedTextFieldKt$OutlinedTextField$3(Modifier modifier, Function2 function2, boolean z2, TextFieldColors textFieldColors, String str, Function1 function1, boolean z3, boolean z4, TextStyle textStyle, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z5, int i2, int i3, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, Function2 function22, Function2 function23, Function2 function24, Function2 function25, Function2 function26, Function2 function27, Shape shape) {
        this.f10571z = modifier;
        this.f10569A = function2;
        this.f10570B = z2;
    ...
    public final void c(Composer composer, int i2) {
        ...
        if (composer2.E((i3 & 3) != 2, i3 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(1874034984, i3, -1, "androidx.compose.material3.OutlinedTextField.<anonymous> (OutlinedTextField.kt:405)");
            }
            Modifier modifier2 = this.f10571z;
            if (this.f10569A != null) {
                composer2.X(-903490605);
            ...
            SolidColor solidColor2 = new SolidColor(this.C.f(this.f10570B), (DefaultConstructorMarker) null);
            String str = this.D;
            ...
            boolean z12 = z5;
            Function2 function2 = this.f10569A;
            boolean z13 = z6;
            ...
            BasicTextFieldKt.e(str3, function1, modifier3, z12, z13, textStyle2, keyboardOptions2, keyboardActions2, z14, i6, i5, visualTransformation, (Function1) null, mutableInteractionSource, solidColor, ComposableLambdaKt.e(-1189274459, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                public final void b(Function2 function2, Composer composer, int i2) {
                    ...
                    if (composer2.E((i3 & 19) != 18, i3 & 1)) {
                        if (ComposerKt.P()) {
                            ComposerKt.Y(-1189274459, i3, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous> (OutlinedTextField.kt:439)");
                        }
                        OutlinedTextFieldDefaults outlinedTextFieldDefaults = OutlinedTextFieldDefaults.f10533a;
                        String str = str2;
                        boolean z2 = z10;
                        ...
                        outlinedTextFieldDefaults2.e(str, function2, z3, z4, visualTransformation, mutableInteractionSource2, z6, function23, function24, function25, function26, function27, function28, function29, textFieldColors, (PaddingValues) null, ComposableLambdaKt.e(-656940872, true, new Function2<Composer, Integer, Unit>() {
                            public final void b(Composer composer, int i2) {
                                int i3 = i2;
                                if (composer.E((i3 & 3) != 2, i3 & 1)) {
                                    if (ComposerKt.P()) {
                                        ComposerKt.Y(-656940872, i3, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous>.<anonymous> (OutlinedTextField.kt:456)");
                                    }
                        ...
                        }, composer2, 54), composer, (i4 << 3) & 112, 14155776, 32768);
                        if (ComposerKt.P()) {
                            ComposerKt.X();
                            return;
                        }
