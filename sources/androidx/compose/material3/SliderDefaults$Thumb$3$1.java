...
@Metadata
@DebugMetadata(c = "androidx.compose.material3.SliderDefaults$Thumb$3$1", f = "Slider.kt", l = {1269}, m = "invokeSuspend")
public final class SliderDefaults$Thumb$3$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int D;
    public final /* synthetic */ MutableInteractionSource E;
    public final /* synthetic */ SnapshotStateList F;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SliderDefaults$Thumb$3$1(MutableInteractionSource mutableInteractionSource, SnapshotStateList snapshotStateList, Continuation continuation) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((SliderDefaults$Thumb$3$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new SliderDefaults$Thumb$3$1(this.E, this.F, continuation);
    }
