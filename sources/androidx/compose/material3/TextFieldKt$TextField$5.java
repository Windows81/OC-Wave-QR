...
@Metadata
final class TextFieldKt$TextField$5 implements Function2<Composer, Integer, Unit> {

    /* renamed from: A  reason: collision with root package name */
    public final /* synthetic */ boolean f11412A;

    /* renamed from: B  reason: collision with root package name */
    public final /* synthetic */ TextFieldColors f11413B;
    ...
    public final /* synthetic */ Modifier f11414z;
    ...
    public final void b(Composer composer, int i2) {
        ...
        if (composer2.E((i3 & 3) != 2, i3 & 1)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-306109195, i3, -1, "androidx.compose.material3.TextField.<anonymous> (TextField.kt:604)");
            }
            Modifier modifier = this.f11414z;
            ...
            SolidColor solidColor2 = new SolidColor(this.f11413B.f(this.f11412A), (DefaultConstructorMarker) null);
            ...
            final TextFieldColors textFieldColors = this.f11413B;
            BasicTextFieldKt.c(textFieldValue3, function1, modifier2, z12, z13, textStyle2, keyboardOptions2, keyboardActions2, z14, i6, i5, visualTransformation, (Function1) null, mutableInteractionSource, solidColor, ComposableLambdaKt.e(-609710734, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                public final void b(Function2 function2, Composer composer, int i2) {
                    ...
                    if (composer2.E((i3 & 19) != 18, i3 & 1)) {
                        if (ComposerKt.P()) {
                            ComposerKt.Y(-609710734, i3, -1, "androidx.compose.material3.TextField.<anonymous>.<anonymous> (TextField.kt:628)");
                        }
                        TextFieldDefaults.f11367a.e(textFieldValue2.i(), function2, z10, z9, visualTransformation2, mutableInteractionSource2, z15, function27, function28, function29, function210, function211, function212, function213, shape, textFieldColors, (PaddingValues) null, (Function2) null, composer, (i3 << 3) & 112, 100663296, 196608);
                        if (ComposerKt.P()) {
                            ComposerKt.X();
                            return;
                        }
