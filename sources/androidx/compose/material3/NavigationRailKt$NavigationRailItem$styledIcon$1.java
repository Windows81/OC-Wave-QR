...
final class NavigationRailKt$NavigationRailItem$styledIcon$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ boolean f10500A;
    ...
    public final /* synthetic */ NavigationRailItemColors f10502z;
    ...
    public final void c(Composer composer, int i2) {
        ...
        if (composer.E((i2 & 3) != 2, 1 & i2)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(206057749, i2, -1, "androidx.compose.material3.NavigationRailItem.<anonymous> (NavigationRail.kt:216)");
            }
            State a2 = SingleValueAnimationKt.a(this.f10502z.b(this.f10500A, this.f10501B), this.C, (String) null, (Function1) null, composer, 0, 12);
            if (this.D == null || (!this.E && !this.f10500A)) {
                composer.X(453016797);
                composer.M();
                modifier = Modifier.f15489d;
            } else {
                composer.X(453015884);
