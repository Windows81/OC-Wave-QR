...
@Metadata
@DebugMetadata(c = "androidx.compose.material3.CardElevation$animateElevation$2$1", f = "Card.kt", l = {727, 737}, m = "invokeSuspend")
public final class CardElevation$animateElevation$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CardElevation$animateElevation$2$1(Animatable animatable, float f2, boolean z2, CardElevation cardElevation, Interaction interaction, Continuation continuation) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((CardElevation$animateElevation$2$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new CardElevation$animateElevation$2$1(this.E, this.F, this.G, this.H, this.I, continuation);
    }
        ...
        if (i2 == 0) {
            ...
            if (!Dp.o(((Dp) this.E.k()).t(), this.F)) {
                if (!this.G) {
                    ...
                    if (Dp.o(t2, this.H.f9359b)) {
                        interaction = new PressInteraction.Press(Offset.f15855b.c(), (DefaultConstructorMarker) null);
                    } else if (Dp.o(t2, this.H.f9361d)) {
                        interaction = new HoverInteraction.Enter();
                    } else if (Dp.o(t2, this.H.f9360c)) {
                        interaction = new FocusInteraction.Focus();
                    } else if (Dp.o(t2, this.H.f9362e)) {
