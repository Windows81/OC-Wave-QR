...
public final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final /* synthetic */ long f12351A;

    /* renamed from: B  reason: collision with root package name */
    public final /* synthetic */ TextStyle f12352B;
    public final /* synthetic */ Function2 C;

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ State f12353z;

    public TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1(State state, long j2, TextStyle textStyle, Function2 function2) {
        this.f12353z = state;
        this.f12351A = j2;
    ...
    public final void c(Composer composer, int i2) {
        if (composer.E((i2 & 3) != 2, 1 & i2)) {
            if (ComposerKt.P()) {
                ComposerKt.Y(-45078754, i2, -1, "androidx.compose.material3.internal.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:192)");
            }
            Modifier.Companion companion = Modifier.f15489d;
            boolean W = composer.W(this.f12353z);
            State state = this.f12353z;
            ...
            TextStyle textStyle = this.f12352B;
