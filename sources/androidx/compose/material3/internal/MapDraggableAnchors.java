...
final class MapDraggableAnchors<T> implements DraggableAnchors<T> {
    ...
    public Object a(float f2, boolean z2) {
        Object obj;
        Iterator it = this.f12296a.entrySet().iterator();
        if (!it.hasNext()) {
            obj = null;
        } else {
            obj = it.next();
    ...
    public float c(Object obj) {
        Float f2 = (Float) this.f12296a.get(obj);
        if (f2 != null) {
    ...
    public float d() {
        Float u0 = CollectionsKt.u0(this.f12296a.values());
        if (u0 != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.d(this.f12296a, ((MapDraggableAnchors) obj).f12296a);
    }

    public boolean f(Object obj) {
        return this.f12296a.containsKey(obj);
    }

    public float g() {
        Float s0 = CollectionsKt.s0(this.f12296a.values());
        if (s0 != null) {
    ...
    public int hashCode() {
        return this.f12296a.hashCode() * 31;
    }

    public String toString() {
        return "MapDraggableAnchors(" + this.f12296a + ')';
    }
}
