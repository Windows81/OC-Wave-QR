...
@Metadata
@DebugMetadata(c = "androidx.compose.material3.ChipElevation$animateElevation$1$1", f = "Chip.kt", l = {2366}, m = "invokeSuspend")
final class ChipElevation$animateElevation$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ChipElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList snapshotStateList, Continuation continuation) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((ChipElevation$animateElevation$1$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new ChipElevation$animateElevation$1$1(this.E, this.F, continuation);
    }
