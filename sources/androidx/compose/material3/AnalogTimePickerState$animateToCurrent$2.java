...
@Metadata
@DebugMetadata(c = "androidx.compose.material3.AnalogTimePickerState$animateToCurrent$2", f = "TimePicker.kt", l = {754}, m = "invokeSuspend")
public final class AnalogTimePickerState$animateToCurrent$2 extends SuspendLambda implements Function1<Continuation<? super AnimationResult<Float, AnimationVector1D>>, Object> {
    ...
    public AnalogTimePickerState$animateToCurrent$2(AnalogTimePickerState analogTimePickerState, float f2, AnimationSpec animationSpec, Continuation continuation) {
    ...
    public final Continuation A(Continuation continuation) {
        return new AnalogTimePickerState$animateToCurrent$2(this.E, this.F, this.G, continuation);
    }

    /* renamed from: B */
    public final Object invoke(Continuation continuation) {
        return ((AnalogTimePickerState$animateToCurrent$2) A(continuation)).x(Unit.f40552a);
    }
