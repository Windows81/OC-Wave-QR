...
final class RopeByteString extends ByteString {
    ...
    public static class Balancer {
        ...
        public final ArrayDeque f21120a;

        public Balancer() {
            this.f21120a = new ArrayDeque();
        }

        public final ByteString b(ByteString byteString, ByteString byteString2) {
            c(byteString);
            c(byteString2);
            ByteString byteString3 = (ByteString) this.f21120a.pop();
            while (!this.f21120a.isEmpty()) {
                byteString3 = new RopeByteString((ByteString) this.f21120a.pop(), byteString3);
            }
            return byteString3;
        }
        ...
        public final void e(ByteString byteString) {
            ...
            if (this.f21120a.isEmpty() || ((ByteString) this.f21120a.peek()).size() >= k0) {
                this.f21120a.push(byteString);
                return;
            }
            int k02 = RopeByteString.k0(d2);
            ByteString byteString2 = (ByteString) this.f21120a.pop();
            while (!this.f21120a.isEmpty() && ((ByteString) this.f21120a.peek()).size() < k02) {
                byteString2 = new RopeByteString((ByteString) this.f21120a.pop(), byteString2);
            }
            RopeByteString ropeByteString = new RopeByteString(byteString2, byteString);
            while (!this.f21120a.isEmpty() && ((ByteString) this.f21120a.peek()).size() < RopeByteString.k0(d(ropeByteString.size()) + 1)) {
                ropeByteString = new RopeByteString((ByteString) this.f21120a.pop(), ropeByteString);
            }
            this.f21120a.push(ropeByteString);
        }
    }
    ...
    public static final class PieceIterator implements Iterator<ByteString.LeafByteString> {
        ...
        /* renamed from: A  reason: collision with root package name */
        public ByteString.LeafByteString f21121A;

        /* renamed from: z  reason: collision with root package name */
        public final ArrayDeque f21122z;

        public final ByteString.LeafByteString b(ByteString byteString) {
            while (byteString instanceof RopeByteString) {
                RopeByteString ropeByteString = (RopeByteString) byteString;
                this.f21122z.push(ropeByteString);
        ...
        public final ByteString.LeafByteString c() {
            ...
            do {
                ArrayDeque arrayDeque = this.f21122z;
                if (arrayDeque == null || arrayDeque.isEmpty()) {
                    return null;
                }
                b2 = b(((RopeByteString) this.f21122z.pop()).F);
            } while (b2.isEmpty());
            return b2;
        }
        ...
        public ByteString.LeafByteString next() {
            ByteString.LeafByteString leafByteString = this.f21121A;
        ...
        public PieceIterator(ByteString byteString) {
            if (byteString instanceof RopeByteString) {
                ...
                this.f21122z = arrayDeque;
                arrayDeque.push(ropeByteString);
                this.f21121A = b(ropeByteString.E);
                return;
            }
            this.f21122z = null;
            this.f21121A = (ByteString.LeafByteString) byteString;
        }
    }
    ...
    public ByteString.ByteIterator iterator() {
        return new ByteString.AbstractByteIterator() {
            ...
            /* renamed from: A  reason: collision with root package name */
            public ByteString.ByteIterator f21117A = c();

            /* renamed from: z  reason: collision with root package name */
            public final PieceIterator f21119z;

            {
                this.f21119z = new PieceIterator(RopeByteString.this);
            }

            public final ByteString.ByteIterator c() {
                if (this.f21119z.hasNext()) {
                    return this.f21119z.next().iterator();
                }
                return null;
            }

            public boolean hasNext() {
                return this.f21117A != null;
            }

            public byte p() {
                ByteString.ByteIterator byteIterator = this.f21117A;
                if (byteIterator != null) {
                    byte p2 = byteIterator.p();
                    if (!this.f21117A.hasNext()) {
                        this.f21117A = c();
                    }
                    return p2;
                }
    ...
    public CodedInputStream F() {
        return CodedInputStream.i(f0(), true);
    }
    ...
    public class RopeInputStream extends InputStream {
        ...
        /* renamed from: A  reason: collision with root package name */
        public ByteString.LeafByteString f21123A;
        ...
        /* renamed from: z  reason: collision with root package name */
        public PieceIterator f21125z;

        public final void a() {
            int i2;
            if (this.f21123A != null && this.C == (i2 = this.f21124B)) {
                this.D += i2;
                this.C = 0;
                if (this.f21125z.hasNext()) {
                    ByteString.LeafByteString d2 = this.f21125z.next();
                    this.f21123A = d2;
                    this.f21124B = d2.size();
                    return;
                }
                this.f21123A = null;
                this.f21124B = 0;
        ...
        public final int d(byte[] bArr, int i2, int i3) {
            ...
            while (i4 > 0) {
                ...
                int min = Math.min(this.f21124B - this.C, i4);
                if (bArr != null) {
                    this.f21123A.v(bArr, this.C, i2, min);
                    i2 += min;
                }
                this.C += min;
                i4 -= min;
        ...
        public int read() {
            a();
            ByteString.LeafByteString leafByteString = this.f21123A;
            if (leafByteString == null) {
                return -1;
            }
            int i2 = this.C;
