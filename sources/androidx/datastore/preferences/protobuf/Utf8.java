...
final class Utf8 {
    ...
    public static final Processor f21207a = ((!UnsafeProcessor.p() || Android.c()) ? new SafeProcessor() : new UnsafeProcessor());
    ...
    public static abstract class Processor {
        ...
        public abstract int e(String str, byte[] bArr, int i2, int i3);

        public final void f(String str, ByteBuffer byteBuffer) {
            if (byteBuffer.hasArray()) {
                int arrayOffset = byteBuffer.arrayOffset();
                Java8Compatibility.c(byteBuffer, Utf8.i(str, byteBuffer.array(), byteBuffer.position() + arrayOffset, byteBuffer.remaining()) - arrayOffset);
        ...
        public final void g(String str, ByteBuffer byteBuffer) {
            ...
            while (i3 < length) {
                try {
                    ...
                    throw new ArrayIndexOutOfBoundsException("Failed writing " + str.charAt(i3) + " at index " + (byteBuffer.position() + Math.max(i3, (position - byteBuffer.position()) + 1)));
                }
            }
            if (i3 == length) {
                Java8Compatibility.c(byteBuffer, position + i3);
                return;
            }
            position += i3;
            while (i3 < length) {
            ...
            Java8Compatibility.c(byteBuffer, position);
        }

        public abstract void h(String str, ByteBuffer byteBuffer);
    ...
    public static final class SafeProcessor extends Processor {
        ...
        public int e(String str, byte[] bArr, int i2, int i3) {
            int i4;
            int i5;
            char charAt;
            int length = str.length();
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public static int q(long r10, int r12) {
            ...
            L_0x0009:
                ...
                long r4 = r10 + r2
                byte r1 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r10)
            ...
            L_0x0029:
                ...
                long r2 = r2 + r10
                byte r10 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r10)
            ...
            L_0x0048:
                int r12 = r12 + -3
                long r2 = r2 + r10
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r10)
            ...
            L_0x005d:
                long r10 = r10 + r8
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r2)
            ...
            L_0x006d:
                ...
                r0 = 3
                long r10 = r10 + r0
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r8)
                if (r0 <= r6) goto L_0x0007
            L_0x008f:
                return r5
            */
        ...
        public static int r(byte[] r10, long r11, int r13) {
            ...
            L_0x0009:
                ...
                long r4 = r11 + r2
                byte r1 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r10, r11)
                if (r1 < 0) goto L_0x0019
                int r13 = r13 + -1
                r11 = r4
                goto L_0x0009
            ...
            L_0x0029:
                ...
                if (r1 < r0) goto L_0x0039
                long r2 = r2 + r11
                byte r11 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r10, r11)
            ...
            L_0x0048:
                int r13 = r13 + -3
                long r2 = r2 + r11
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r10, r11)
                if (r0 > r6) goto L_0x0064
                r7 = -96
                if (r1 != r4) goto L_0x0057
                if (r0 < r7) goto L_0x0064
            ...
            L_0x005d:
                long r11 = r11 + r8
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r10, r2)
                if (r0 <= r6) goto L_0x0007
            L_0x0064:
                return r5
            L_0x0065:
            ...
            L_0x006d:
                ...
                r0 = 3
                long r11 = r11 + r0
                byte r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r10, r8)
                if (r0 <= r6) goto L_0x0007
            L_0x008f:
                return r5
            */
        ...
        public static int t(byte[] bArr, long j2, int i2) {
            ...
            while (true) {
                int i5 = i3 + 8;
                if (i5 <= i2 && (UnsafeUtil.F(bArr, UnsafeUtil.f21190h + j2) & -9187201950435737472L) == 0) {
                    j2 += 8;
                    i3 = i5;
                }
            }
        ...
        public String b(byte[] bArr, int i2, int i3) {
            Charset charset = Internal.f21003b;
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int e(java.lang.String r25, byte[] r26, int r27, int r28) {
            /*
                r24 = this;
                r0 = r25
                r1 = r26
            ...
            L_0x001a:
                ...
                long r11 = r11 + r4
                byte r3 = (byte) r13
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r4, r3)
                int r2 = r2 + 1
                r4 = r11
                goto L_0x001a
            L_0x002f:
            ...
            L_0x0033:
                ...
                long r14 = r4 + r11
                byte r13 = (byte) r13
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r4, r13)
                r22 = r6
                r17 = r10
                r20 = r11
                r4 = r14
            ...
            L_0x004f:
                ...
                byte r11 = (byte) r11
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r4, r11)
                long r4 = r4 + r15
                r11 = r13 & 63
                r11 = r11 | r3
                byte r11 = (byte) r11
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r9, r11)
            L_0x0070:
                r22 = r6
                r20 = 1
                goto L_0x00f8
            ...
            L_0x0085:
                ...
                r15 = r15 | r3
                byte r15 = (byte) r15
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r9, r15)
                r9 = 3
                long r4 = r4 + r9
                r9 = r13 & 63
                r9 = r9 | r3
                byte r9 = (byte) r9
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r11, r9)
                goto L_0x0070
            L_0x00ad:
                r11 = 4
                long r20 = r6 - r11
                ...
                byte r10 = (byte) r10
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r4, r10)
                r22 = r6
                long r6 = r4 + r15
                int r10 = r2 >>> 12
                r10 = r10 & 63
                r10 = r10 | r3
                byte r10 = (byte) r10
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r11, r10)
                r10 = 3
                long r11 = r4 + r10
                int r10 = r2 >>> 6
                r10 = r10 & 63
                r10 = r10 | r3
                byte r10 = (byte) r10
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r6, r10)
                r6 = 4
                long r4 = r4 + r6
                r2 = r2 & 63
                r2 = r2 | r3
                byte r2 = (byte) r2
                androidx.datastore.preferences.protobuf.UnsafeUtil.R(r1, r11, r2)
                r2 = r9
            L_0x00f8:
                int r2 = r2 + 1
                r9 = r14
            ...
            L_0x0144:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.Utf8.UnsafeProcessor.e(java.lang.String, byte[], int, int):int");
        }
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void h(java.lang.String r28, java.nio.ByteBuffer r29) {
            /*
                r27 = this;
                r0 = r28
                r1 = r29
                long r2 = androidx.datastore.preferences.protobuf.UnsafeUtil.k(r29)
                int r4 = r29.position()
                long r4 = (long) r4
                long r4 = r4 + r2
                int r6 = r29.limit()
            ...
            L_0x0024:
                ...
                long r12 = r12 + r4
                byte r14 = (byte) r15
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r4, r14)
                int r9 = r9 + 1
                r4 = r12
                goto L_0x0024
            L_0x0039:
                ...
                long r4 = r4 - r2
                int r0 = (int) r4
                androidx.datastore.preferences.protobuf.Java8Compatibility.c(r1, r0)
                return
            L_0x0041:
                ...
                long r16 = r4 + r12
                byte r15 = (byte) r15
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r4, r15)
                r19 = r2
                r1 = r9
                r9 = r14
                r4 = r16
            ...
            L_0x005b:
                ...
                byte r3 = (byte) r3
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r4, r3)
                long r4 = r4 + r17
                r3 = r15 & 63
                r14 = 128(0x80, float:1.794E-43)
                r3 = r3 | r14
                byte r3 = (byte) r3
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r1, r3)
            L_0x007e:
                r1 = r9
            ...
            L_0x0091:
                ...
                r1 = r1 | r14
                byte r1 = (byte) r1
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r12, r1)
                goto L_0x007e
            L_0x00b8:
                r12 = 4
                long r25 = r6 - r12
                ...
                r3 = r3 | r9
                byte r3 = (byte) r3
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r12, r3)
                long r12 = r4 + r21
                int r3 = r2 >>> 6
                r3 = r3 & 63
                r3 = r3 | r9
                byte r3 = (byte) r3
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r14, r3)
                r14 = 4
                long r4 = r4 + r14
                r2 = r2 & 63
                r2 = r2 | r9
                byte r2 = (byte) r2
                androidx.datastore.preferences.protobuf.UnsafeUtil.Q(r12, r2)
            L_0x0100:
                int r1 = r1 + 1
                r14 = r9
                r2 = r19
            ...
            L_0x0153:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.Utf8.UnsafeProcessor.h(java.lang.String, java.nio.ByteBuffer):void");
        }

        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0058, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.y(r12, r0) > -65) goto L_0x005d;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:54:0x009e, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.y(r12, r0) > -65) goto L_0x00a0;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int l(int r11, byte[] r12, int r13, int r14) {
            ...
            L_0x0010:
                ...
                long r6 = r6 + r0
                byte r11 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r12, r0)
            ...
            L_0x002a:
                ...
                int r11 = androidx.datastore.preferences.protobuf.Utf8.o(r2, r11)
                return r11
            L_0x0043:
                r0 = r8
            L_0x0044:
            ...
            L_0x005e:
                ...
                long r8 = r0 + r6
                byte r3 = androidx.datastore.preferences.protobuf.UnsafeUtil.y(r12, r0)
                int r11 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
                if (r11 < 0) goto L_0x0073
                int r11 = androidx.datastore.preferences.protobuf.Utf8.o(r2, r3)
                return r11
            L_0x0073:
                r11 = 0
                r0 = r8
            ...
            L_0x0079:
                ...
                int r11 = androidx.datastore.preferences.protobuf.Utf8.p(r2, r3, r11)
                return r11
            L_0x008a:
                r0 = r8
            L_0x008b:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x002d, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.x(r0) > -65) goto L_0x0033;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0061, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.x(r0) > -65) goto L_0x0063;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:53:0x00a3, code lost:
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.x(r0) > -65) goto L_0x00a5;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public int o(int r10, java.nio.ByteBuffer r11, int r12, int r13) {
            /*
                ...
                long r0 = androidx.datastore.preferences.protobuf.UnsafeUtil.k(r11)
                long r2 = (long) r12
                long r0 = r0 + r2
                int r13 = r13 - r12
                long r11 = (long) r13
            ...
            L_0x001a:
                ...
                long r5 = r5 + r0
                byte r10 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r0)
            ...
            L_0x0034:
                ...
                int r10 = androidx.datastore.preferences.protobuf.Utf8.o(r13, r10)
                return r10
            L_0x004d:
                r0 = r7
            L_0x004e:
            ...
            L_0x0064:
                ...
                long r7 = r0 + r5
                byte r2 = androidx.datastore.preferences.protobuf.UnsafeUtil.x(r0)
                int r10 = (r7 > r11 ? 1 : (r7 == r11 ? 0 : -1))
                if (r10 < 0) goto L_0x0079
                int r10 = androidx.datastore.preferences.protobuf.Utf8.o(r13, r2)
                return r10
            L_0x0079:
                r10 = 0
                r0 = r7
            ...
            L_0x007f:
                ...
                int r10 = androidx.datastore.preferences.protobuf.Utf8.p(r13, r2, r10)
                return r10
            L_0x0090:
                r0 = r7
            L_0x0091:
    ...
    public static String g(ByteBuffer byteBuffer, int i2, int i3) {
        return f21207a.a(byteBuffer, i2, i3);
    }

    public static String h(byte[] bArr, int i2, int i3) {
        return f21207a.b(bArr, i2, i3);
    }

    public static int i(String str, byte[] bArr, int i2, int i3) {
        return f21207a.e(str, bArr, i2, i3);
    }

    public static void j(String str, ByteBuffer byteBuffer) {
        f21207a.f(str, byteBuffer);
    }
    ...
    public static boolean s(ByteBuffer byteBuffer) {
        return f21207a.i(byteBuffer, byteBuffer.position(), byteBuffer.remaining());
    }

    public static boolean t(byte[] bArr) {
        return f21207a.j(bArr, 0, bArr.length);
    }

    public static boolean u(byte[] bArr, int i2, int i3) {
        return f21207a.j(bArr, i2, i3);
    }

    public static int v(int i2, ByteBuffer byteBuffer, int i3, int i4) {
        return f21207a.k(i2, byteBuffer, i3, i4);
    }

    public static int w(int i2, byte[] bArr, int i3, int i4) {
        return f21207a.l(i2, bArr, i3, i4);
    }
}
