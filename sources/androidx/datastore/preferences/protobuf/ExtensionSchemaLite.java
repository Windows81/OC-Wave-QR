...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f20949a     // Catch:{ NoSuchFieldError -> 0x00d8 }
    ...
    public Object g(Object obj, Reader reader, Object obj2, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet, Object obj3, UnknownFieldSchema unknownFieldSchema) {
        ...
        if (!generatedExtension.f20994d.q() || !generatedExtension.f20994d.v()) {
            if (generatedExtension.a() != WireFormat.FieldType.ENUM) {
                switch (AnonymousClass1.f20949a[generatedExtension.a().ordinal()]) {
                    case 1:
                    ...
                    case 17:
                        if (!generatedExtension.d()) {
                            Object i3 = fieldSet.i(generatedExtension.f20994d);
                            if (i3 instanceof GeneratedMessageLite) {
                                Schema d2 = Protobuf.a().d(i3);
                                if (!((GeneratedMessageLite) i3).J()) {
                                    Object g2 = d2.g();
                                    d2.a(g2, i3);
                                    fieldSet.y(generatedExtension.f20994d, g2);
                                    i3 = g2;
                                }
                                reader.Y(i3, d2, extensionRegistryLite);
                                return obj3;
                            }
                        }
                        obj4 = reader.V(generatedExtension.b().getClass(), extensionRegistryLite);
                        break;
                    case 18:
                        if (!generatedExtension.d()) {
                            Object i4 = fieldSet.i(generatedExtension.f20994d);
                            if (i4 instanceof GeneratedMessageLite) {
                                Schema d3 = Protobuf.a().d(i4);
                                if (!((GeneratedMessageLite) i4).J()) {
                                    Object g3 = d3.g();
                                    d3.a(g3, i4);
                                    fieldSet.y(generatedExtension.f20994d, g3);
                                    i4 = g3;
                                }
                                reader.W(i4, d3, extensionRegistryLite);
                                return obj3;
                            }
                        }
                        obj4 = reader.U(generatedExtension.b().getClass(), extensionRegistryLite);
                        break;
                    default:
                        obj4 = null;
                        break;
                ...
                int i5 = reader.i();
                if (generatedExtension.f20994d.f().a(i5) == null) {
                    return SchemaUtil.J(obj, c2, i5, obj3, unknownFieldSchema);
                }
                obj4 = Integer.valueOf(i5);
            }
            if (generatedExtension.d()) {
                fieldSet.a(generatedExtension.f20994d, obj4);
            } else {
                int i6 = AnonymousClass1.f20949a[generatedExtension.a().ordinal()];
                if ((i6 == 17 || i6 == 18) && (i2 = fieldSet.i(generatedExtension.f20994d)) != null) {
                    obj4 = Internal.h(i2, obj4);
                }
                fieldSet.y(generatedExtension.f20994d, obj4);
            }
        } else {
            switch (AnonymousClass1.f20949a[generatedExtension.a().ordinal()]) {
                case 1:
                ...
                case 14:
                    arrayList = new ArrayList();
                    reader.C(arrayList);
                    obj3 = SchemaUtil.z(obj, c2, arrayList, generatedExtension.f20994d.f(), obj3, unknownFieldSchema);
                    break;
                default:
                    throw new IllegalStateException("Type cannot be packed: " + generatedExtension.f20994d.s());
            }
            fieldSet.y(generatedExtension.f20994d, arrayList);
        }
        return obj3;
    }
    ...
    public void h(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet) {
        ...
        fieldSet.y(generatedExtension.f20994d, reader.U(generatedExtension.b().getClass(), extensionRegistryLite));
    }
    ...
    public void i(ByteString byteString, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet) {
        ...
        h2.b1(F, extensionRegistryLite);
        fieldSet.y(generatedExtension.f20994d, h2.C());
        F.a(0);
    }
    ...
    public void j(Writer writer, Map.Entry entry) {
        ...
        if (extensionDescriptor.q()) {
            switch (AnonymousClass1.f20949a[extensionDescriptor.s().ordinal()]) {
                case 1:
                    SchemaUtil.O(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 2:
                ...
                case 4:
                    ...
                    return;
                case 5:
                    SchemaUtil.U(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 6:
                    SchemaUtil.R(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 7:
                    SchemaUtil.Q(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 8:
                    SchemaUtil.M(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 9:
                    SchemaUtil.c0(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 10:
                    SchemaUtil.X(extensionDescriptor.i(), (List) entry.getValue(), writer, extensionDescriptor.v());
                    return;
                case 11:
            ...
            switch (AnonymousClass1.f20949a[extensionDescriptor.s().ordinal()]) {
                ...
                case 14:
                    ...
                    return;
                case 15:
                    writer.a0(extensionDescriptor.i(), (ByteString) entry.getValue());
                    return;
                case 16:
                    writer.z(extensionDescriptor.i(), (String) entry.getValue());
                    return;
                case 17:
                    writer.d0(extensionDescriptor.i(), entry.getValue(), Protobuf.a().c(entry.getValue().getClass()));
                    return;
                case 18:
                    writer.b0(extensionDescriptor.i(), entry.getValue(), Protobuf.a().c(entry.getValue().getClass()));
                    return;
                default:
                    return;
            }
