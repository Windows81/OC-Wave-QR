...
interface Writer {
    ...
    void Y(int i2, List list, Schema schema);

    void Z(int i2, List list, Schema schema);

    void a0(int i2, ByteString byteString);

    void b0(int i2, Object obj, Schema schema);

    void c0(int i2, MapEntryLite.Metadata metadata, Map map);

    void d0(int i2, Object obj, Schema schema);
