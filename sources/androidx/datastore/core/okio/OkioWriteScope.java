...
public final class OkioWriteScope<T> extends OkioReadScope<T> implements WriteScope<T> {
    ...
    public java.lang.Object a(java.lang.Object r9, kotlin.coroutines.Continuation r10) {
        ...
        L_0x0018:
            ...
            kotlin.ResultKt.b(r10)     // Catch:{ all -> 0x0036 }
            goto L_0x0072
        L_0x0036:
            r10 = move-exception
            goto L_0x0085
        ...
        L_0x0040:
            ...
            okio.Path r2 = r8.h()
            okio.FileHandle r10 = r10.p(r2)
            r5 = 0
            okio.Sink r2 = okio.FileHandle.y(r10, r5, r3, r4)     // Catch:{ all -> 0x00a5 }
            okio.BufferedSink r2 = okio.Okio.c(r2)     // Catch:{ all -> 0x00a5 }
            androidx.datastore.core.okio.OkioSerializer r5 = r8.i()     // Catch:{ all -> 0x0081 }
            r0.C = r10     // Catch:{ all -> 0x0081 }
            r0.D = r10     // Catch:{ all -> 0x0081 }
            r0.E = r2     // Catch:{ all -> 0x0081 }
            r0.H = r3     // Catch:{ all -> 0x0081 }
        ...
        L_0x0072:
            ...
            kotlin.Unit r10 = kotlin.Unit.f40552a     // Catch:{ all -> 0x0036 }
        ...
        L_0x008b:
            r9 = move-exception
            kotlin.ExceptionsKt.a(r10, r9)     // Catch:{ all -> 0x0090 }
            goto L_0x0093
        L_0x0090:
            r9 = move-exception
            r10 = r0
        ...
        L_0x0095:
            ...
            kotlin.jvm.internal.Intrinsics.f(r10)     // Catch:{ all -> 0x0090 }
            kotlin.Unit r9 = kotlin.Unit.f40552a     // Catch:{ all -> 0x0090 }
