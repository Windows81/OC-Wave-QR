...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final AppCompatBackgroundHelper f1114A;

    /* renamed from: B  reason: collision with root package name */
    public final AppCompatTextHelper f1115B;
    public AppCompatEmojiTextHelper C;

    /* renamed from: z  reason: collision with root package name */
    public final AppCompatCompoundButtonHelper f1116z;
    ...
    public void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1114A;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f1115B;
    ...
    public int getCompoundPaddingLeft() {
        ...
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.f1116z;
