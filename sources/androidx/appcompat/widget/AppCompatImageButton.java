...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final AppCompatImageHelper f1095A;

    /* renamed from: B  reason: collision with root package name */
    public boolean f1096B;

    /* renamed from: z  reason: collision with root package name */
    public final AppCompatBackgroundHelper f1097z;
    ...
    public void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f1097z;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatImageHelper appCompatImageHelper = this.f1095A;
    ...
    public boolean hasOverlappingRendering() {
        return this.f1095A.f() && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        AppCompatImageHelper appCompatImageHelper = this.f1095A;
        if (!(appCompatImageHelper == null || drawable == null || this.f1096B)) {
            appCompatImageHelper.h(drawable);
        }
        super.setImageDrawable(drawable);
        AppCompatImageHelper appCompatImageHelper2 = this.f1095A;
    ...
    public AppCompatImageButton(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f1097z = appCompatBackgroundHelper;
        appCompatBackgroundHelper.e(attributeSet, i2);
        AppCompatImageHelper appCompatImageHelper = new AppCompatImageHelper(this);
        this.f1095A = appCompatImageHelper;
