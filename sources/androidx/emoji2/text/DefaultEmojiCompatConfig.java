...
public final class DefaultEmojiCompatConfig {
    ...
    public static class DefaultEmojiCompatConfigFactory {
        ...
        public final DefaultEmojiCompatConfigHelper f21249a;

        public DefaultEmojiCompatConfigFactory(DefaultEmojiCompatConfigHelper defaultEmojiCompatConfigHelper) {
            this.f21249a = defaultEmojiCompatConfigHelper == null ? e() : defaultEmojiCompatConfigHelper;
        }
        ...
        public final FontRequest d(ProviderInfo providerInfo, PackageManager packageManager) {
            ...
            return new FontRequest(str, str2, "emojicompat-emoji-font", b(this.f21249a.b(packageManager, str2)));
        }
        ...
        public final ProviderInfo g(PackageManager packageManager) {
            for (ResolveInfo a2 : this.f21249a.c(packageManager, new Intent("androidx.content.action.LOAD_EMOJI_FONT"), 0)) {
                ProviderInfo a3 = this.f21249a.a(a2);
                if (f(a3)) {
                    return a3;
                }
            }
        ...
        public FontRequest h(Context context) {
            ...
            Preconditions.g(packageManager, "Package manager required to locate emoji font provider");
