...
public final class NavType$Companion$BoolListType$1 extends CollectionNavType<List<? extends Boolean>> {
    ...
    public List f(String str) {
        ...
        return CollectionsKt.e(NavType.f22410n.f(str));
    }
    ...
    public void h(Bundle bundle, String str, List list) {
        Intrinsics.i(bundle, "bundle");
        Intrinsics.i(str, "key");
        bundle.putBooleanArray(str, list != null ? CollectionsKt.G0(list) : null);
    }
    ...
    public boolean j(java.util.List r4, java.util.List r5) {
        ...
        L_0x001d:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.NavType$Companion$BoolListType$1.j(java.util.List, java.util.List):boolean");
    }
}
