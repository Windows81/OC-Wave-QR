...
public final class InternalNavType$DoubleListType$1 extends CollectionNavType<List<? extends Double>> {
    ...
    public List f(String str) {
        ...
        return CollectionsKt.e(InternalNavType.f22587a.d().f(str));
    }
    ...
    public java.util.List g(java.lang.String r2, java.util.List r3) {
        ...
        L_0x0019:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.serialization.InternalNavType$DoubleListType$1.g(java.lang.String, java.util.List):java.util.List");
    }
    ...
    public void h(Bundle bundle, String str, List list) {
        Intrinsics.i(bundle, "bundle");
        Intrinsics.i(str, "key");
        bundle.putDoubleArray(str, list != null ? CollectionsKt.I0(list) : null);
    }
    ...
    public boolean j(java.util.List r4, java.util.List r5) {
        ...
        L_0x001d:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.serialization.InternalNavType$DoubleListType$1.j(java.util.List, java.util.List):boolean");
    }
}
