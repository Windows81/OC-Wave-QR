...
public final class InternalNavType$StringNullableListType$1 extends CollectionNavType<List<? extends String>> {
    ...
    public List f(String str) {
        ...
        return CollectionsKt.e(NavType.f22413q.f(str));
    }
    ...
    public java.util.List g(java.lang.String r2, java.util.List r3) {
        ...
        L_0x0019:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.serialization.InternalNavType$StringNullableListType$1.g(java.lang.String, java.util.List):java.util.List");
    }
    ...
    public boolean j(java.util.List r4, java.util.List r5) {
        ...
        L_0x001d:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.serialization.InternalNavType$StringNullableListType$1.j(java.util.List, java.util.List):boolean");
    }
}
