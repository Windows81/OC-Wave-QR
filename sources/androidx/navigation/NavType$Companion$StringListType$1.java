...
public final class NavType$Companion$StringListType$1 extends CollectionNavType<List<? extends String>> {
    ...
    public boolean j(java.util.List r4, java.util.List r5) {
        ...
        L_0x001d:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.navigation.NavType$Companion$StringListType$1.j(java.util.List, java.util.List):boolean");
    }
}
