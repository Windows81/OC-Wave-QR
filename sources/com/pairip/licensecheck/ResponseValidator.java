...
public class ResponseValidator {
    ...
    private static void verifySignature(String str, String str2, String str3, PublicKey publicKey) throws LicenseCheckException {
        try {
            ...
            throw new LicenseCheckException(String.format("Could not find %s algorithm on the device", new Object[]{str3}), e2);
        } catch (InvalidKeyException e3) {
            throw new LicenseCheckException("Could not sign data with the public key", e3);
        } catch (SignatureException e4) {
            throw new LicenseCheckException("Could not parse returned signature.", e4);
        } catch (IllegalArgumentException e5) {
            throw new LicenseCheckException("Could not base64 decode returned signature", e5);
        }
    }
    ...
    private static PublicKey getPublicKey() throws LicenseCheckException {
        try {
            ...
            throw new LicenseCheckException(String.format("%s algorithm not found on device", new Object[]{KEY_FACTORY_ALGORITHM}), e2);
        } catch (IllegalArgumentException e3) {
            throw new LicenseCheckException("Could not decode public key", e3);
        } catch (InvalidKeySpecException e4) {
            throw new LicenseCheckException("Could not create key specification from the public key", e4);
        }
    }
