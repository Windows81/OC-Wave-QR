...
@Metadata
public final class Lokalise$appCountry$2 extends Lambda implements Function0<String> {
    ...
    public final String invoke() {
        ...
        return access$getAppContext$p.getResources().getConfiguration().getLocales().get(0).getCountry();
    }
}
