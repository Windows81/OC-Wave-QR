...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.useCases.auth.ResendActivationEmailUseCase$invoke-gIAlu-s$$inlined$retrofit$default$1", f = "ResendActivationEmailUseCase.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.useCases.auth.ResendActivationEmailUseCase$invoke-gIAlu-s$$inlined$retrofit$default$1  reason: invalid class name */
public final class ResendActivationEmailUseCase$invokegIAlus$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Unit>>, Object> {
    public int D;
    public final /* synthetic */ Json E;
    public final /* synthetic */ ResendActivationEmailUseCase F;
    public final /* synthetic */ String G;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ResendActivationEmailUseCase$invokegIAlus$$inlined$retrofit$default$1(Json json, Continuation continuation, ResendActivationEmailUseCase resendActivationEmailUseCase, String str) {
        super(2, continuation);
        this.E = json;
        this.F = resendActivationEmailUseCase;
        this.G = str;
    }

    /* renamed from: A */
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((ResendActivationEmailUseCase$invokegIAlus$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new ResendActivationEmailUseCase$invokegIAlus$$inlined$retrofit$default$1(this.E, continuation, this.F, this.G);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.useCases.auth.ResendActivationEmailUseCase r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.UserDataApi r5 = r5.f33820a     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.models.SendActivationEmailRequest r1 = new com.hansecom.mapi.models.SendActivationEmailRequest     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            ...
            java.lang.Object r5 = r5.k(r1, r4)     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x00ef:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.useCases.auth.ResendActivationEmailUseCase$invokegIAlus$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
