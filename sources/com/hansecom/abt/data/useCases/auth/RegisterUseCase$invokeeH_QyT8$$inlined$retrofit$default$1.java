...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.useCases.auth.RegisterUseCase$invoke-eH_QyT8$$inlined$retrofit$default$1", f = "RegisterUseCase.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.useCases.auth.RegisterUseCase$invoke-eH_QyT8$$inlined$retrofit$default$1  reason: invalid class name */
public final class RegisterUseCase$invokeeH_QyT8$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends User>>, Object> {
    public int D;
    public final /* synthetic */ Json E;
    public final /* synthetic */ RegisterUseCase F;
    public final /* synthetic */ UserCreateRequest G;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RegisterUseCase$invokeeH_QyT8$$inlined$retrofit$default$1(Json json, Continuation continuation, RegisterUseCase registerUseCase, UserCreateRequest userCreateRequest) {
        super(2, continuation);
        this.E = json;
        this.F = registerUseCase;
        this.G = userCreateRequest;
    }

    /* renamed from: A */
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((RegisterUseCase$invokeeH_QyT8$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new RegisterUseCase$invokeeH_QyT8$$inlined$retrofit$default$1(this.E, continuation, this.F, this.G);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.useCases.auth.RegisterUseCase r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.UserDataApi r5 = r5.f33814a     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.models.UserCreateRequest r1 = r4.G     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            r4.D = r2     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            java.lang.Object r5 = r5.n(r1, r4)     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x0109:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.useCases.auth.RegisterUseCase$invokeeH_QyT8$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
