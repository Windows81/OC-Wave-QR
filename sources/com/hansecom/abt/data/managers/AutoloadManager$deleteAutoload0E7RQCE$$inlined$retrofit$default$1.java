...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.managers.AutoloadManager$deleteAutoload-0E7RQCE$$inlined$retrofit$default$1", f = "AutoloadManager.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.managers.AutoloadManager$deleteAutoload-0E7RQCE$$inlined$retrofit$default$1  reason: invalid class name */
public final class AutoloadManager$deleteAutoload0E7RQCE$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends FareMediaAutoload>>, Object> {
    public int D;
    ...
    public AutoloadManager$deleteAutoload0E7RQCE$$inlined$retrofit$default$1(Json json, Continuation continuation, AutoloadManager autoloadManager, String str, long j2) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AutoloadManager$deleteAutoload0E7RQCE$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new AutoloadManager$deleteAutoload0E7RQCE$$inlined$retrofit$default$1(this.E, continuation, this.F, this.G, this.H);
    }
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:48:0x00e4 */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:37:0x00b8 A[Catch:{ IOException -> 0x0012, all -> 0x000f }] */
    /* JADX WARNING: Removed duplicated region for block: B:38:0x00bd A[Catch:{ IOException -> 0x0012, all -> 0x000f }] */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00c0 A[Catch:{ IOException -> 0x0012, all -> 0x000f }] */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:34:0x00b4=Splitter:B:34:0x00b4, B:48:0x00e4=Splitter:B:48:0x00e4} */
    ...
    public final java.lang.Object x(java.lang.Object r6) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.managers.AutoloadManager r6 = r5.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.AutoloadsApi r6 = r6.f33290a     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            java.lang.String r1 = r5.G     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            long r3 = r5.H     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x0069:
            ...
            java.lang.Class<com.hansecom.mapi.models.FareMediaAutoload> r0 = com.hansecom.mapi.models.FareMediaAutoload.class
        ...
        L_0x008c:
            ...
            okhttp3.ResponseBody r6 = r6.d()     // Catch:{ all -> 0x00b3 }
            if (r6 == 0) goto L_0x00b3
            java.lang.String r6 = r6.k()     // Catch:{ all -> 0x00b3 }
            ...
            java.lang.Object r6 = r0.b(r1, r6)     // Catch:{ all -> 0x00b3 }
            com.hansecom.abt.api.oauth.OAuthErrorResponse r6 = (com.hansecom.abt.api.oauth.OAuthErrorResponse) r6     // Catch:{ all -> 0x00b3 }
            goto L_0x00b4
        L_0x00b3:
            r6 = r3
        L_0x00b4:
        ...
        L_0x00c4:
            ...
            throw r0     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        L_0x00c8:
            okhttp3.ResponseBody r1 = r6.d()     // Catch:{ all -> 0x00e4 }
        ...
        L_0x010f:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.managers.AutoloadManager$deleteAutoload0E7RQCE$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
