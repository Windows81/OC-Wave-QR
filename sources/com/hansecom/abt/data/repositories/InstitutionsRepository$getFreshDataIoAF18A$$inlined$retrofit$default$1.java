...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.InstitutionsRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1", f = "InstitutionsRepository.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.repositories.InstitutionsRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1  reason: invalid class name */
public final class InstitutionsRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends Institution>>>, Object> {
    public int D;
    public final /* synthetic */ Json E;
    public final /* synthetic */ InstitutionsRepository F;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InstitutionsRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(Json json, Continuation continuation, InstitutionsRepository institutionsRepository) {
        super(2, continuation);
        this.E = json;
        this.F = institutionsRepository;
    }

    /* renamed from: A */
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((InstitutionsRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new InstitutionsRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(this.E, continuation, this.F);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.repositories.InstitutionsRepository r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.InstitutionsApi r5 = r5.f33516k     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x010d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.InstitutionsRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
