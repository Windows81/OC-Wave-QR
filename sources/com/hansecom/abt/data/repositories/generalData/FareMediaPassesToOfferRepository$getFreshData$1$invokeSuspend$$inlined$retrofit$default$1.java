...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.generalData.FareMediaPassesToOfferRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1", f = "FareMediaPassesToOfferRepository.kt", l = {86}, m = "invokeSuspend")
public final class FareMediaPassesToOfferRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends FareProductOffer>>>, Object> {
    public int D;
    ...
    public FareMediaPassesToOfferRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1(Json json, Continuation continuation, FareMediaPassesToOfferRepository fareMediaPassesToOfferRepository, String str) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((FareMediaPassesToOfferRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new FareMediaPassesToOfferRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1(this.E, continuation, this.F, this.G);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.repositories.generalData.FareMediaPassesToOfferRepository r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.GeneralDataApi r5 = r5.f33639f     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x010f:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.generalData.FareMediaPassesToOfferRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
