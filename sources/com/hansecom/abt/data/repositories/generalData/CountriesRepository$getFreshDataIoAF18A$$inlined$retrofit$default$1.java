...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.generalData.CountriesRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1", f = "CountriesRepository.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.repositories.generalData.CountriesRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1  reason: invalid class name */
public final class CountriesRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends Country>>>, Object> {
    public int D;
    public final /* synthetic */ Json E;
    public final /* synthetic */ CountriesRepository F;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CountriesRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(Json json, Continuation continuation, CountriesRepository countriesRepository) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((CountriesRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new CountriesRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(this.E, continuation, this.F);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.repositories.generalData.CountriesRepository r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.GeneralDataApi r5 = r5.f33606k     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            r4.D = r2     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            java.lang.Object r5 = r5.e(r4)     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x010d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.generalData.CountriesRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
