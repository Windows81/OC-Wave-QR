...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.generalData.VirtualFareMediaRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1", f = "VirtualFareMediaRepository.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.repositories.generalData.VirtualFareMediaRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1  reason: invalid class name */
public final class VirtualFareMediaRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends VirtualFareMedia>>>, Object> {
    public int D;
    public final /* synthetic */ Json E;
    public final /* synthetic */ VirtualFareMediaRepository F;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VirtualFareMediaRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(Json json, Continuation continuation, VirtualFareMediaRepository virtualFareMediaRepository) {
        super(2, continuation);
        this.E = json;
        this.F = virtualFareMediaRepository;
    }

    /* renamed from: A */
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((VirtualFareMediaRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new VirtualFareMediaRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(this.E, continuation, this.F);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001e:
            ...
            com.hansecom.abt.data.repositories.generalData.VirtualFareMediaRepository r5 = r4.F     // Catch:{ IOException -> 0x0013, all -> 0x0010 }
            com.hansecom.mapi.apis.GeneralDataApi r5 = r5.f33673k     // Catch:{ IOException -> 0x0013, all -> 0x0010 }
            r4.D = r2     // Catch:{ IOException -> 0x0013, all -> 0x0010 }
            java.lang.Object r5 = com.hansecom.mapi.apis.GeneralDataApi.DefaultImpls.a(r5, r3, r4, r2, r3)     // Catch:{ IOException -> 0x0013, all -> 0x0010 }
        ...
        L_0x010d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.generalData.VirtualFareMediaRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
