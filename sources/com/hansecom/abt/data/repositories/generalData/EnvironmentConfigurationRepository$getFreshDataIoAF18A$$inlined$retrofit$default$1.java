...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.generalData.EnvironmentConfigurationRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1", f = "EnvironmentConfigurationRepository.kt", l = {86}, m = "invokeSuspend")
/* renamed from: com.hansecom.abt.data.repositories.generalData.EnvironmentConfigurationRepository$getFreshData-IoAF18A$$inlined$retrofit$default$1  reason: invalid class name */
public final class EnvironmentConfigurationRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends EnvironmentConfiguration>>, Object> {
    public int D;
    public final /* synthetic */ Json E;
    public final /* synthetic */ EnvironmentConfigurationRepository F;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public EnvironmentConfigurationRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(Json json, Continuation continuation, EnvironmentConfigurationRepository environmentConfigurationRepository) {
        super(2, continuation);
        this.E = json;
        this.F = environmentConfigurationRepository;
    }

    /* renamed from: A */
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((EnvironmentConfigurationRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new EnvironmentConfigurationRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1(this.E, continuation, this.F);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.repositories.generalData.EnvironmentConfigurationRepository r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.ConfigurationApi r5 = r5.f33617k     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            r4.D = r2     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            java.lang.Object r5 = r5.a(r4)     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x0061:
            ...
            java.lang.Class<com.hansecom.mapi.models.EnvironmentConfiguration> r0 = com.hansecom.mapi.models.EnvironmentConfiguration.class
        ...
        L_0x0107:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.generalData.EnvironmentConfigurationRepository$getFreshDataIoAF18A$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
