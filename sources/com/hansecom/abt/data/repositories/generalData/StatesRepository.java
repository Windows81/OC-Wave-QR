...
@Singleton
@Metadata
public final class StatesRepository extends MultipleValueRepository<Integer, List<? extends String>> {

    /* renamed from: f  reason: collision with root package name */
    public final GeneralDataApi f33661f;

    /* renamed from: g  reason: collision with root package name */
    public final Function2 f33662g = new StatesRepository$getFreshData$1(this, (Continuation) null);

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public StatesRepository(com.hansecom.mapi.apis.GeneralDataApi r7, kotlinx.serialization.json.Json r8, com.hansecom.abt.data.preferences.base.DataStoreFileProducer r9) {
        /*
            r6 = this;
            ...
            r1.<init>(r2, r4)
            com.hansecom.abt.data.repositories.generalData.StatesRepository$special$$inlined$create$1 r2 = new com.hansecom.abt.data.repositories.generalData.StatesRepository$special$$inlined$create$1
            r2.<init>(r8, r1)
            com.hansecom.abt.data.repositories.generalData.StatesRepository$special$$inlined$create$2 r8 = new com.hansecom.abt.data.repositories.generalData.StatesRepository$special$$inlined$create$2
            java.lang.String r1 = "States"
            r8.<init>(r1, r9, r2)
            r6.<init>(r3, r0, r8)
            r6.f33661f = r7
            com.hansecom.abt.data.repositories.generalData.StatesRepository$getFreshData$1 r7 = new com.hansecom.abt.data.repositories.generalData.StatesRepository$getFreshData$1
            r8 = 0
            r7.<init>(r6, r8)
            r6.f33662g = r7
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.generalData.StatesRepository.<init>(com.hansecom.mapi.apis.GeneralDataApi, kotlinx.serialization.json.Json, com.hansecom.abt.data.preferences.base.DataStoreFileProducer):void");
    }
