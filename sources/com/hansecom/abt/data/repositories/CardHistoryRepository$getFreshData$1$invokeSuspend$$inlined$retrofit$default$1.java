...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.CardHistoryRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1", f = "CardHistoryRepository.kt", l = {86}, m = "invokeSuspend")
public final class CardHistoryRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends TransactionSearchResult>>, Object> {
    public int D;
    ...
    public CardHistoryRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1(Json json, Continuation continuation, CardHistoryRepository cardHistoryRepository, String str) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((CardHistoryRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new CardHistoryRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1(this.E, continuation, this.F, this.G);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x00c3 A[Catch:{ IOException -> 0x0012, all -> 0x000f }] */
    /* JADX WARNING: Removed duplicated region for block: B:38:0x00c8 A[Catch:{ IOException -> 0x0012, all -> 0x000f }] */
    /* JADX WARNING: Removed duplicated region for block: B:40:0x00cb A[Catch:{ IOException -> 0x0012, all -> 0x000f }] */
    ...
    public final java.lang.Object x(java.lang.Object r13) {
        ...
        L_0x0097:
            ...
            okhttp3.ResponseBody r13 = r13.d()     // Catch:{ all -> 0x00be }
            if (r13 == 0) goto L_0x00be
            java.lang.String r13 = r13.k()     // Catch:{ all -> 0x00be }
            r0.a()     // Catch:{ all -> 0x00be }
            com.hansecom.abt.api.oauth.OAuthErrorResponse$Companion r1 = com.hansecom.abt.api.oauth.OAuthErrorResponse.Companion     // Catch:{ all -> 0x00be }
            kotlinx.serialization.KSerializer r1 = r1.serializer()     // Catch:{ all -> 0x00be }
            kotlinx.serialization.DeserializationStrategy r1 = (kotlinx.serialization.DeserializationStrategy) r1     // Catch:{ all -> 0x00be }
            java.lang.Object r13 = r0.b(r1, r13)     // Catch:{ all -> 0x00be }
            com.hansecom.abt.api.oauth.OAuthErrorResponse r13 = (com.hansecom.abt.api.oauth.OAuthErrorResponse) r13     // Catch:{ all -> 0x00be }
            goto L_0x00bf
        L_0x00be:
            r13 = r3
        L_0x00bf:
        ...
        L_0x00cf:
            ...
            throw r0     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        L_0x00d3:
            okhttp3.ResponseBody r1 = r13.d()     // Catch:{ all -> 0x00ef }
            if (r1 == 0) goto L_0x00ef
            java.lang.String r1 = r1.k()     // Catch:{ all -> 0x00ef }
            r0.a()     // Catch:{ all -> 0x00ef }
            com.hansecom.mapi.models.ErrorResponse$Companion r2 = com.hansecom.mapi.models.ErrorResponse.Companion     // Catch:{ all -> 0x00ef }
            kotlinx.serialization.KSerializer r2 = r2.serializer()     // Catch:{ all -> 0x00ef }
            kotlinx.serialization.DeserializationStrategy r2 = (kotlinx.serialization.DeserializationStrategy) r2     // Catch:{ all -> 0x00ef }
            java.lang.Object r0 = r0.b(r2, r1)     // Catch:{ all -> 0x00ef }
        ...
        L_0x011a:
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.CardHistoryRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
