...
@Metadata
@DebugMetadata(c = "com.hansecom.abt.data.repositories.FareMediaInstitutionsRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1", f = "FareMediaInstitutionsRepository.kt", l = {86}, m = "invokeSuspend")
public final class FareMediaInstitutionsRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends Institution>>>, Object> {
    public int D;
    ...
    public FareMediaInstitutionsRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1(Json json, Continuation continuation, FareMediaInstitutionsRepository fareMediaInstitutionsRepository, String str) {
    ...
    public final Object m(CoroutineScope coroutineScope, Continuation continuation) {
        return ((FareMediaInstitutionsRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1) s(coroutineScope, continuation)).x(Unit.f40552a);
    }

    public final Continuation s(Object obj, Continuation continuation) {
        return new FareMediaInstitutionsRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1(this.E, continuation, this.F, this.G);
    }
    ...
    public final java.lang.Object x(java.lang.Object r5) {
        ...
        L_0x001d:
            ...
            com.hansecom.abt.data.repositories.FareMediaInstitutionsRepository r5 = r4.F     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            com.hansecom.mapi.apis.InstitutionsApi r5 = r5.f33451f     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            java.lang.String r1 = r4.G     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            r4.D = r2     // Catch:{ IOException -> 0x0012, all -> 0x000f }
            java.lang.Object r5 = r5.c(r1, r4)     // Catch:{ IOException -> 0x0012, all -> 0x000f }
        ...
        L_0x010f:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.data.repositories.FareMediaInstitutionsRepository$getFreshData$1$invokeSuspend$$inlined$retrofit$default$1.x(java.lang.Object):java.lang.Object");
    }
}
