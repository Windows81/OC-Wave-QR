...
@Metadata
/* renamed from: com.hansecom.abt.ui.components.formFields.ComposableSingletons$SwitchFieldKt$lambda-1$1  reason: invalid class name */
public final class ComposableSingletons$SwitchFieldKt$lambda1$1 implements Function2<Composer, Integer, Unit> {

    /* renamed from: z  reason: collision with root package name */
    public static final ComposableSingletons$SwitchFieldKt$lambda1$1 f38306z = new ComposableSingletons$SwitchFieldKt$lambda1$1();
    ...
    public final void g(Composer composer, int i2) {
        if ((i2 & 3) != 2 || !composer.t()) {
            if (ComposerKt.P()) {
                ComposerKt.Y(1342944165, i2, -1, "com.hansecom.abt.ui.components.formFields.ComposableSingletons$SwitchFieldKt.lambda-1.<anonymous> (SwitchField.kt:97)");
            }
