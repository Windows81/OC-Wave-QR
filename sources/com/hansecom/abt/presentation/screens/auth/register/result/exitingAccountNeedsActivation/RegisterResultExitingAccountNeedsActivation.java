...
@Metadata
public interface RegisterResultExitingAccountNeedsActivation {
    ...
    public interface Action {
        ...
        public static final class Resend implements Action {
            ...
            public static final Resend f34521a = new Resend();
    ...
    public interface Effect {
        ...
        public static final class Error implements Effect {
            ...
            public boolean equals(Object obj) {
                ...
                return (obj instanceof Error) && Intrinsics.d(this.f34522a, ((Error) obj).f34522a);
            }
            ...
            public String toString() {
                StringValue stringValue = this.f34522a;
        ...
        public static final class Success implements Effect {
            ...
            public boolean equals(Object obj) {
                ...
                return (obj instanceof Success) && Intrinsics.d(this.f34523a, ((Success) obj).f34523a);
            }
    ...
    public static final class State implements Parcelable {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.d(this.f34525z, state.f34525z) && this.f34524A == state.f34524A;
        }

        public int hashCode() {
            return (this.f34525z.hashCode() * 31) + Boolean.hashCode(this.f34524A);
        }

        public String toString() {
            String str = this.f34525z;
            boolean z2 = this.f34524A;
            return "State(email=" + str + ", isLoading=" + z2 + ")";
        }

        public final void writeToParcel(Parcel parcel, int i2) {
            Intrinsics.i(parcel, "dest");
            parcel.writeString(this.f34525z);
            parcel.writeInt(this.f34524A ? 1 : 0);
        }
