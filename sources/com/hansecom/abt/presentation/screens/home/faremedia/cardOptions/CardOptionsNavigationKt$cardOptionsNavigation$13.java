...
import com.hansecom.abt.presentation.screens.home.faremedia.transferBalance.TransferBalanceScreenKt;
...
@Metadata
public final class CardOptionsNavigationKt$cardOptionsNavigation$13 implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ NavHostController f36538z;

    public CardOptionsNavigationKt$cardOptionsNavigation$13(NavHostController navHostController) {
        this.f36538z = navHostController;
    }
    ...
    public final void b(AnimatedContentScope animatedContentScope, NavBackStackEntry navBackStackEntry, Composer composer, int i2) {
        ...
        if (ComposerKt.P()) {
            ComposerKt.Y(-1281299624, i2, -1, "com.hansecom.abt.presentation.screens.home.faremedia.cardOptions.cardOptionsNavigation.<anonymous> (CardOptionsNavigation.kt:345)");
        }
        NavHostController navHostController = this.f36538z;
        boolean a2 = ((AppFeatures) composer.C(AppFeaturesKt.c())).a();
        final NavHostController navHostController2 = this.f36538z;
        AppFeatureGuardKt.b(navHostController, a2, (String) null, ComposableLambdaKt.e(-666347306, true, new Function2<Composer, Integer, Unit>() {
            ...
            public final void c(Composer composer, int i2) {
                if ((i2 & 3) != 2 || !composer.t()) {
                    if (ComposerKt.P()) {
                        ComposerKt.Y(-666347306, i2, -1, "com.hansecom.abt.presentation.screens.home.faremedia.cardOptions.cardOptionsNavigation.<anonymous>.<anonymous> (CardOptionsNavigation.kt:346)");
                    }
                    LaunchTracingKt.c("TransferBalanceScreen", composer, 6);
                    composer.X(2121622493);
                    ...
                    if (l2 || g2 == Composer.f14567a.a()) {
                        g2 = new C0551p(navHostController);
                        composer.N(g2);
                    }
                    composer.M();
                    TransferBalanceScreenKt.h((TransferBalanceViewModel) null, (Function0) g2, composer, 0, 1);
                    if (ComposerKt.P()) {
                        ComposerKt.X();
                        return;
                    }
