...
@Metadata
public final class FareCappingScreenKt$Content$2$invoke$lambda$4$lambda$3$lambda$2$$inlined$items$default$4 extends Lambda implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ List f36722z;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FareCappingScreenKt$Content$2$invoke$lambda$4$lambda$3$lambda$2$$inlined$items$default$4(List list) {
        super(4);
        this.f36722z = list;
    }
    ...
    public final void b(LazyItemScope lazyItemScope, int i2, Composer composer, int i3) {
        ...
        if (composer.E((i4 & 147) != 146, i4 & 1)) {
            ...
            composer.X(717662131);
            Modifier.Companion companion = Modifier.f15489d;
            FareCappingConcludedCardKt.b((FareCappingCardState.Concluded) this.f36722z.get(i2), SizeKt.h(companion, 0.0f, 1, (Object) null), composer, 48, 0);
