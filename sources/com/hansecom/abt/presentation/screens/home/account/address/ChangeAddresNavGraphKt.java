...
@Metadata
public final class ChangeAddresNavGraphKt {
    public static final void a(NavGraphBuilder navGraphBuilder, NavController navController, Context context) {
        ...
        NavGraphBuilder navGraphBuilder2 = new NavGraphBuilder(navGraphBuilder.i(), (Object) ChangeAddressDestination.INSTANCE, Reflection.b(ChangeAddressGraph.class), MapsKt.h());
        String string = context.getString(R.string.S1);
        Intrinsics.h(string, "getString(...)");
        ComposableLambda c2 = ComposableLambdaKt.c(-940365183, true, new ChangeAddresNavGraphKt$changeAddressNavGraph$1$1(navController));
        Map h2 = MapsKt.h();
        List<NavDeepLink> m2 = CollectionsKt.m();
        Class<ComposeNavigator> cls = ComposeNavigator.class;
        ComposeNavigatorDestinationBuilder composeNavigatorDestinationBuilder = new ComposeNavigatorDestinationBuilder((ComposeNavigator) navGraphBuilder2.i().d(cls), Reflection.b(ChangeAddressDestination.class), h2, c2);
        ...
        ComposableLambda c3 = ComposableLambdaKt.c(-1734821782, true, new ChangeAddresNavGraphKt$changeAddressNavGraph$1$2(navController));
        Map h3 = MapsKt.h();
        List<NavDeepLink> m3 = CollectionsKt.m();
        ComposeNavigatorDestinationBuilder composeNavigatorDestinationBuilder2 = new ComposeNavigatorDestinationBuilder((ComposeNavigator) navGraphBuilder2.i().d(cls), Reflection.b(ChangeAddressChooseCountryDestination.class), h3, c3);
        ...
        String string3 = context.getString(R.string.S1);
        Intrinsics.h(string3, "getString(...)");
        ComposableLambda c4 = ComposableLambdaKt.c(-440402935, true, new ChangeAddresNavGraphKt$changeAddressNavGraph$1$3(navController));
        Map h4 = MapsKt.h();
        List<NavDeepLink> m4 = CollectionsKt.m();
        ComposeNavigatorDestinationBuilder composeNavigatorDestinationBuilder3 = new ComposeNavigatorDestinationBuilder((ComposeNavigator) navGraphBuilder2.i().d(cls), Reflection.b(ChangeAddressChooseStateDestination.class), h4, c4);
