...
@Metadata
public final class ChangeAddresNavGraphKt$changeAddressNavGraph$1$3 implements Function4<AnimatedContentScope, NavBackStackEntry, Composer, Integer, Unit> {

    /* renamed from: z  reason: collision with root package name */
    public final /* synthetic */ NavController f35109z;

    public ChangeAddresNavGraphKt$changeAddressNavGraph$1$3(NavController navController) {
        this.f35109z = navController;
    }
    ...
    public final void b(androidx.compose.animation.AnimatedContentScope r9, androidx.navigation.NavBackStackEntry r10, androidx.compose.runtime.Composer r11, int r12) {
        /*
            ...
            r9 = -1
            java.lang.String r0 = "com.hansecom.abt.presentation.screens.home.account.address.changeAddressNavGraph.<anonymous>.<anonymous> (ChangeAddresNavGraph.kt:50)"
            r1 = -440402935(0xffffffffe5bffc09, float:-1.1332765E23)
            androidx.compose.runtime.ComposerKt.Y(r1, r12, r9, r0)
        L_0x0019:
            r9 = 891649184(0x35257ca0, float:6.1648643E-7)
            r11.X(r9)
            boolean r9 = r11.W(r10)
            androidx.navigation.NavController r10 = r8.f35109z
        ...
        L_0x005e:
            ...
            r11.S()
            r11.S()
            com.hansecom.abt.presentation.screens.home.account.address.ChangeAddressViewModel r10 = (com.hansecom.abt.presentation.screens.home.account.address.ChangeAddressViewModel) r10
            kotlin.jvm.functions.Function0 r12 = com.hansecom.abt.util.CallDeviceOnBackButtonKt.b(r11, r9)
            com.hansecom.abt.presentation.screens.home.account.address.chooseState.ChangeAddressChooseStateScreenKt.d(r10, r12, r11, r9)
            boolean r9 = androidx.compose.runtime.ComposerKt.P()
        ...
        L_0x0082:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hansecom.abt.presentation.screens.home.account.address.ChangeAddresNavGraphKt$changeAddressNavGraph$1$3.b(androidx.compose.animation.AnimatedContentScope, androidx.navigation.NavBackStackEntry, androidx.compose.runtime.Composer, int):void");
    }
