...
public final class HybridBinarizer extends GlobalHistogramBinarizer {
    ...
    public static int[][] e(byte[] r17, int r18, int r19, int r20, int r21) {
        /*
            r0 = r18
            r1 = r19
            r2 = 8
        ...
        L_0x00b1:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.common.HybridBinarizer.e(byte[], int, int, int, int):int[][]");
    }

    public static void f(byte[] bArr, int i2, int i3, int i4, int i5, int[][] iArr, BitMatrix bitMatrix) {
        int i6 = i2;
        int i7 = i3;
        int i8 = i5 - 8;
        int i9 = i4 - 8;
        for (int i10 = 0; i10 < i7; i10++) {
            ...
            for (int i12 = 0; i12 < i6; i12++) {
                ...
                for (int i16 = -2; i16 <= 2; i16++) {
                    int[] iArr2 = iArr[g2 + i16];
                    i15 += iArr2[g3 - 2] + iArr2[g3 - 1] + iArr2[g3] + iArr2[g3 + 1] + iArr2[2 + g3];
                }
                h(bArr, i14, i11, i15 / 25, i4, bitMatrix);
            }
        }
    }
    ...
    public static void h(byte[] bArr, int i2, int i3, int i4, int i5, BitMatrix bitMatrix) {
        int i6 = (i3 * i5) + i2;
        int i7 = 0;
        while (i7 < 8) {
            for (int i8 = 0; i8 < 8; i8++) {
                if ((bArr[i6 + i8] & 255) <= i4) {
                    bitMatrix.i(i2 + i8, i3 + i7);
                }
            }
            i7++;
            i6 += i5;
    ...
    public BitMatrix a() {
        BitMatrix bitMatrix = this.f32616e;
        if (bitMatrix != null) {
            return bitMatrix;
        }
        ...
        if (d2 < 40 || a2 < 40) {
            ...
            int i5 = i4;
            int[][] e2 = e(b3, i3, i5, d2, a2);
            BitMatrix bitMatrix2 = new BitMatrix(d2, a2);
            f(b3, i3, i5, d2, a2, e2, bitMatrix2);
            this.f32616e = bitMatrix2;
        }
        return this.f32616e;
    }
}
