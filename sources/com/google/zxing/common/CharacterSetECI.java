...
public enum CharacterSetECI {
    ...
    public static final Map c0 = null;
    public static final Map d0 = null;
    ...
    static {
        ...
        for (CharacterSetECI characterSetECI : values()) {
            for (int valueOf : characterSetECI.f32611z) {
                c0.put(Integer.valueOf(valueOf), characterSetECI);
            }
            d0.put(characterSetECI.name(), characterSetECI);
            for (String put : characterSetECI.f32610A) {
                d0.put(put, characterSetECI);
            }
        }
    }
    ...
    CharacterSetECI(int i2) {
        this(r2, r3, new int[]{i2}, new String[0]);
    }

    public static CharacterSetECI d(String str) {
        return (CharacterSetECI) d0.get(str);
    }

    public int f() {
        return this.f32611z[0];
    }

    /* access modifiers changed from: public */
    CharacterSetECI(int i2, String... strArr) {
        this.f32611z = new int[]{i2};
        this.f32610A = strArr;
    }
