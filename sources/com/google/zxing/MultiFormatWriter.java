...
public final class MultiFormatWriter implements Writer {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0090:
                int[] r0 = f32452a     // Catch:{ NoSuchFieldError -> 0x009c }
    ...
    public BitMatrix a(String str, BarcodeFormat barcodeFormat, int i2, int i3, Map map) {
        Writer eAN8Writer;
        switch (AnonymousClass1.f32452a[barcodeFormat.ordinal()]) {
            case 1:
        ...
        return eAN8Writer.a(str, barcodeFormat, i2, i3, map);
    }
