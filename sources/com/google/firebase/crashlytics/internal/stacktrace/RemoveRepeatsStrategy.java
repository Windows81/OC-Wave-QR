...
public class RemoveRepeatsStrategy implements StackTraceTrimmingStrategy {
    ...
    public static boolean b(StackTraceElement[] stackTraceElementArr, int i2, int i3) {
        int i4 = i3 - i2;
    ...
    public static StackTraceElement[] c(StackTraceElement[] stackTraceElementArr, int i2) {
        int i3;
    ...
    public StackTraceElement[] a(StackTraceElement[] stackTraceElementArr) {
        StackTraceElement[] c2 = c(stackTraceElementArr, this.f30693a);
