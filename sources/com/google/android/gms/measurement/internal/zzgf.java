...
public final class zzgf extends zzf {
    ...
    public final zzge f26315c = new zzge(this, a(), "google_app_measurement_local.db");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        m().G().a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:62:?, code lost:
        r11.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:73:?, code lost:
        m().G().a("Failed to load user property from local database");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:88:?, code lost:
        m().G().a("Failed to load conditional user property from local database");
     */
    ...
    public final java.util.List C(int r22) {
        ...
        L_0x001d:
            ...
            r9 = 1
            android.database.sqlite.SQLiteDatabase r15 = r21.K()     // Catch:{ SQLiteFullException -> 0x01e2, SQLiteDatabaseLockedException -> 0x01cf, SQLiteException -> 0x01a4, all -> 0x01a1 }
            if (r15 != 0) goto L_0x003d
            r1.f26316d = r9     // Catch:{ SQLiteFullException -> 0x0039, SQLiteDatabaseLockedException -> 0x0036, SQLiteException -> 0x0032, all -> 0x002e }
        ...
        L_0x003d:
            ...
            long r10 = B(r15)     // Catch:{ SQLiteFullException -> 0x019b, SQLiteDatabaseLockedException -> 0x0036, SQLiteException -> 0x0197, all -> 0x002e }
            r19 = -1
        ...
        L_0x00b4:
            ...
            goto L_0x00c7
        L_0x00b6:
            com.google.android.gms.measurement.internal.zzgi r0 = r21.m()     // Catch:{ all -> 0x00b4 }
            com.google.android.gms.measurement.internal.zzgk r0 = r0.G()     // Catch:{ all -> 0x00b4 }
        ...
        L_0x00e4:
            ...
            goto L_0x00fe
        L_0x00e6:
            com.google.android.gms.measurement.internal.zzgi r0 = r21.m()     // Catch:{ all -> 0x00e4 }
            com.google.android.gms.measurement.internal.zzgk r0 = r0.G()     // Catch:{ all -> 0x00e4 }
        ...
        L_0x011b:
            ...
            goto L_0x0135
        L_0x011d:
            com.google.android.gms.measurement.internal.zzgi r0 = r21.m()     // Catch:{ all -> 0x011b }
            com.google.android.gms.measurement.internal.zzgk r0 = r0.G()     // Catch:{ all -> 0x011b }
        ...
        L_0x0139:
            ...
            com.google.android.gms.measurement.internal.zzgi r0 = r21.m()     // Catch:{ SQLiteFullException -> 0x00b0, SQLiteDatabaseLockedException -> 0x018a, SQLiteException -> 0x00ac, all -> 0x00a8 }
            com.google.android.gms.measurement.internal.zzgk r0 = r0.L()     // Catch:{ SQLiteFullException -> 0x00b0, SQLiteDatabaseLockedException -> 0x018a, SQLiteException -> 0x00ac, all -> 0x00a8 }
        ...
        L_0x014b:
            com.google.android.gms.measurement.internal.zzgi r0 = r21.m()     // Catch:{ SQLiteFullException -> 0x00b0, SQLiteDatabaseLockedException -> 0x018a, SQLiteException -> 0x00ac, all -> 0x00a8 }
            com.google.android.gms.measurement.internal.zzgk r0 = r0.G()     // Catch:{ SQLiteFullException -> 0x00b0, SQLiteDatabaseLockedException -> 0x018a, SQLiteException -> 0x00ac, all -> 0x00a8 }
        ...
        L_0x01b3:
            ...
            goto L_0x002f
        L_0x01b7:
            com.google.android.gms.measurement.internal.zzgi r5 = r21.m()     // Catch:{ all -> 0x01b3 }
            com.google.android.gms.measurement.internal.zzgk r5 = r5.G()     // Catch:{ all -> 0x01b3 }
            r5.b(r2, r0)     // Catch:{ all -> 0x01b3 }
            r1.f26316d = r9     // Catch:{ all -> 0x01b3 }
        ...
        L_0x020b:
            throw r0
        L_0x020c:
            com.google.android.gms.measurement.internal.zzgi r0 = r21.m()
            com.google.android.gms.measurement.internal.zzgk r0 = r0.L()
            java.lang.String r2 = "Failed to read events from database in reasonable time"
            r0.a(r2)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzgf.C(int):java.util.List");
    }
    ...
    public final boolean D(int r17, byte[] r18) {
        ...
        L_0x0023:
            ...
            r7 = 0
            r8 = 1
            android.database.sqlite.SQLiteDatabase r9 = r16.K()     // Catch:{ SQLiteFullException -> 0x00ff, SQLiteDatabaseLockedException -> 0x00ed, SQLiteException -> 0x00c1, all -> 0x00be }
            if (r9 != 0) goto L_0x0040
            r1.f26316d = r8     // Catch:{ SQLiteFullException -> 0x003d, SQLiteDatabaseLockedException -> 0x00ee, SQLiteException -> 0x0038 }
        ...
        L_0x0062:
            ...
            com.google.android.gms.measurement.internal.zzgi r0 = r16.m()     // Catch:{ SQLiteFullException -> 0x005c, SQLiteDatabaseLockedException -> 0x00bc, SQLiteException -> 0x005a, all -> 0x0056 }
            com.google.android.gms.measurement.internal.zzgk r0 = r0.G()     // Catch:{ SQLiteFullException -> 0x005c, SQLiteDatabaseLockedException -> 0x00bc, SQLiteException -> 0x005a, all -> 0x0056 }
        ...
        L_0x00cf:
            ...
            goto L_0x0057
        L_0x00d2:
            com.google.android.gms.measurement.internal.zzgi r2 = r16.m()     // Catch:{ all -> 0x00cf }
            com.google.android.gms.measurement.internal.zzgk r2 = r2.G()     // Catch:{ all -> 0x00cf }
            java.lang.String r4 = "Error writing entry to local database"
            r2.b(r4, r0)     // Catch:{ all -> 0x00cf }
            r2 = 1
            r1.f26316d = r2     // Catch:{ all -> 0x00cf }
        ...
        L_0x00ff:
            ...
            r9 = r7
        L_0x0101:
            com.google.android.gms.measurement.internal.zzgi r2 = r16.m()     // Catch:{ all -> 0x0035 }
            com.google.android.gms.measurement.internal.zzgk r2 = r2.G()     // Catch:{ all -> 0x0035 }
            java.lang.String r4 = "Error writing entry; local database full"
            r2.b(r4, r0)     // Catch:{ all -> 0x0035 }
            r2 = 1
            r1.f26316d = r2     // Catch:{ all -> 0x0035 }
        ...
        L_0x012b:
            throw r0
        L_0x012c:
            com.google.android.gms.measurement.internal.zzgi r0 = r16.m()
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzgf.D(int, byte[]):boolean");
    }

    public final boolean E(zzaf zzaf) {
        j();
        byte[] q0 = zzop.q0(zzaf);
        if (q0.length <= 131072) {
            return D(2, q0);
        }
        m().I().a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }

    public final boolean F(zzbh zzbh) {
        ...
        m().I().a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    public final boolean G(zzok zzok) {
        Parcel obtain = Parcel.obtain();
        ...
        m().I().a("User property too long for local database. Sending directly to service");
        return false;
    }
    ...
    public final void H() {
        ...
        try {
            ...
            if (K != null && (delete = K.delete("messages", (String) null, (String[]) null)) > 0) {
                m().K().b("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e2) {
            m().G().b("Error resetting local analytics data. error", e2);
        }
    }
    ...
    public final boolean J() {
        ...
        L_0x0015:
            ...
            r10.f26316d = r5     // Catch:{ SQLiteFullException -> 0x002b, SQLiteDatabaseLockedException -> 0x0068, SQLiteException -> 0x0029 }
        ...
        L_0x0055:
            com.google.android.gms.measurement.internal.zzgi r8 = r10.m()     // Catch:{ all -> 0x0027 }
            com.google.android.gms.measurement.internal.zzgk r8 = r8.G()     // Catch:{ all -> 0x0027 }
            r8.b(r0, r7)     // Catch:{ all -> 0x0027 }
            r10.f26316d = r5     // Catch:{ all -> 0x0027 }
        ...
        L_0x008e:
            throw r0
        L_0x008f:
            com.google.android.gms.measurement.internal.zzgi r0 = r10.m()
            com.google.android.gms.measurement.internal.zzgk r0 = r0.L()
            java.lang.String r1 = "Error deleting app launch break from local database in reasonable time"
            r0.a(r1)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzgf.J():boolean");
    }
    ...
    public final SQLiteDatabase K() {
        ...
        SQLiteDatabase writableDatabase = this.f26315c.getWritableDatabase();
