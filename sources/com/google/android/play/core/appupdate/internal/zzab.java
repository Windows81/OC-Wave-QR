...
public final class zzab {
    ...
    public static final zzm f27415a = new zzm("PhoneskyVerificationUtils");
        ...
        try {
            if (context.getPackageManager().getApplicationInfo("com.android.vending", 0).enabled) {
                ...
                if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                    f27415a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
                } else {
                    for (Signature byteArray : signatureArr) {
                        String a2 = zzaa.a(byteArray.toByteArray());
