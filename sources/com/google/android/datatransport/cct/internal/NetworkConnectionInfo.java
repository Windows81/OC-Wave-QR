...
public abstract class NetworkConnectionInfo {
    ...
    public enum MobileSubtype {
        ...
        public static final SparseArray V = null;

        /* renamed from: z  reason: collision with root package name */
        public final int f23986z;
        ...
        public static MobileSubtype d(int i2) {
            return (MobileSubtype) V.get(i2);
        }
    ...
    public enum NetworkType {
        ...
        public static final SparseArray T = null;

        /* renamed from: z  reason: collision with root package name */
        public final int f23989z;
        ...
        public static NetworkType d(int i2) {
            return (NetworkType) T.get(i2);
        }
