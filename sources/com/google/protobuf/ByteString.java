...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public static final ByteString f31983A = new LiteralByteString(Internal.f32170d);

    /* renamed from: B  reason: collision with root package name */
    public static final ByteArrayCopier f31984B = (Android.c() ? new SystemByteArrayCopier() : new ArraysByteArrayCopier());
    ...
    public static final class CodedBuilder {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final CodedOutputStream f31989a;
        ...
        public ByteString a() {
            this.f31989a.k();
            return new LiteralByteString(this.f31990b);
        }
        ...
        public CodedBuilder(int i2) {
            ...
            this.f31990b = bArr;
            this.f31989a = CodedOutputStream.U0(bArr);
        }
    }
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final CodedInputStream F() {
            return CodedInputStream.l(this.D, d0(), size(), true);
        }
        ...
        public final ByteString M(int i2, int i3) {
            ...
            return n2 == 0 ? ByteString.f31983A : new BoundedByteString(this.D, d0() + i2, n2);
        }
    ...
    public static ByteString p(Iterable iterable) {
        ...
        return i2 == 0 ? f31983A : h(iterable.iterator(), i2);
    }
    ...
    public static ByteString s(byte[] bArr, int i2, int i3) {
        ...
        return new LiteralByteString(f31984B.a(bArr, i2, i3));
    }

    public static ByteString u(String str) {
        return new LiteralByteString(str.getBytes(Internal.f32168b));
    }
    ...
    public ByteIterator iterator() {
        return new AbstractByteIterator() {
            ...
            /* renamed from: z  reason: collision with root package name */
            public int f31988z = 0;

            {
                this.f31986A = ByteString.this.size();
            }

            public boolean hasNext() {
                return this.f31988z < this.f31986A;
            }
    ...
    public static final class Output extends OutputStream {
        ...
        /* renamed from: A  reason: collision with root package name */
        public final ArrayList f31991A;
        ...
        /* renamed from: z  reason: collision with root package name */
        public final int f31993z;

        public final void a(int i2) {
            this.f31991A.add(new LiteralByteString(this.C));
            int length = this.f31992B + this.C.length;
            this.f31992B = length;
            this.C = new byte[Math.max(this.f31993z, Math.max(i2, length >>> 1))];
            this.D = 0;
        }

        public synchronized int b() {
            return this.f31992B + this.D;
        }
