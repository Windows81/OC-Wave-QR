...
abstract class BinaryReader implements Reader {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f31943a     // Catch:{ NoSuchFieldError -> 0x00cc }
    ...
    public static final class SafeHeapReader extends BinaryReader {
        ...
        public void A(List list) {
            ...
            if (list instanceof LongArrayList) {
                ...
                int b2 = WireFormat.b(this.f31948e);
                if (b2 == 1) {
                    do {
                        longArrayList.m(w());
                        if (!j()) {
                    ...
                    } while (b0() == this.f31948e);
                    this.f31946c = i3;
                } else if (b2 == 2) {
                    int b0 = b0();
                    m0(b0);
                    int i4 = this.f31946c + b0;
                    while (this.f31946c < i4) {
                        longArrayList.m(X());
                    }
                } else {
                ...
                int b3 = WireFormat.b(this.f31948e);
                if (b3 == 1) {
                    do {
                    ...
                    int b02 = b0();
                    m0(b02);
                    int i5 = this.f31946c + b02;
                    while (this.f31946c < i5) {
        ...
        public void B(List list) {
            ...
            if (list instanceof IntArrayList) {
                ...
                if (b2 == 0) {
                    ...
                    int b0 = this.f31946c + b0();
                    while (this.f31946c < b0) {
                        intArrayList.g0(b0());
                    }
                    f0(b0);
                } else {
                ...
                if (b3 == 0) {
                    ...
                    int b02 = this.f31946c + b0();
                    while (this.f31946c < b02) {
        ...
        public ByteString M() {
            ...
            e0(b0);
            ByteString Y = this.f31944a ? ByteString.Y(this.f31945b, this.f31946c, b0) : ByteString.s(this.f31945b, this.f31946c, b0);
            this.f31946c += b0;
            return Y;
        }
        ...
        public boolean O() {
            int i2;
            if (j() || (i2 = this.f31948e) == this.f31949f) {
                return false;
            }
        ...
        public void Q(List list) {
            int i2;
            if (WireFormat.b(this.f31948e) == 2) {
                do {
                    list.add(M());
                    if (!j()) {
                        i2 = this.f31946c;
        ...
        public final Object Y(Schema schema, ExtensionRegistryLite extensionRegistryLite) {
            Object g2 = schema.g();
            f(g2, schema, extensionRegistryLite);
            schema.d(g2);
            return g2;
        }
        ...
        public String Z(boolean z2) {
            ...
            String str = new String(this.f31945b, this.f31946c, b0, Internal.f32168b);
            this.f31946c += b0;
            return str;
        }
        ...
        public void a(List list, Schema schema, ExtensionRegistryLite extensionRegistryLite) {
            int i2;
            if (WireFormat.b(this.f31948e) == 3) {
                int i3 = this.f31948e;
                do {
        ...
        public void c(Object obj, Schema schema, ExtensionRegistryLite extensionRegistryLite) {
            int i2 = this.f31949f;
            this.f31949f = WireFormat.c(WireFormat.a(this.f31948e), 4);
            try {
                schema.i(obj, this, extensionRegistryLite);
                if (this.f31948e != this.f31949f) {
        ...
        public Object e(Class cls, ExtensionRegistryLite extensionRegistryLite) {
            g0(3);
            return m(Protobuf.a().c(cls), extensionRegistryLite);
        }

        public final void e0(int i2) {
            if (i2 < 0 || i2 > this.f31947d - this.f31946c) {
                throw InvalidProtocolBufferException.m();
            }
        }
        ...
        public void g(java.util.Map r8, com.google.protobuf.MapEntryLite.Metadata r9, com.google.protobuf.ExtensionRegistryLite r10) {
            /*
                ...
                int r3 = r3 + r1
                r7.f31947d = r3
                java.lang.Object r1 = r9.f32219b     // Catch:{ all -> 0x0025 }
                java.lang.Object r3 = r9.f32221d     // Catch:{ all -> 0x0025 }
            L_0x0016:
            ...
            L_0x003b:
                com.google.protobuf.WireFormat$FieldType r4 = r9.f32220c     // Catch:{ InvalidWireTypeException -> 0x0050 }
                java.lang.Object r5 = r9.f32221d     // Catch:{ InvalidWireTypeException -> 0x0050 }
                java.lang.Class r5 = r5.getClass()     // Catch:{ InvalidWireTypeException -> 0x0050 }
                java.lang.Object r3 = r7.l(r4, r5, r10)     // Catch:{ InvalidWireTypeException -> 0x0050 }
                goto L_0x0016
            L_0x0048:
                com.google.protobuf.WireFormat$FieldType r4 = r9.f32218a     // Catch:{ InvalidWireTypeException -> 0x0050 }
                r5 = 0
                java.lang.Object r1 = r7.l(r4, r5, r5)     // Catch:{ InvalidWireTypeException -> 0x0050 }
                goto L_0x0016
            L_0x0050:
            ...
            L_0x005d:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.BinaryReader.SafeHeapReader.g(java.util.Map, com.google.protobuf.MapEntryLite$Metadata, com.google.protobuf.ExtensionRegistryLite):void");
        }

        public final void g0(int i2) {
            if (WireFormat.b(this.f31948e) != i2) {
                throw InvalidProtocolBufferException.e();
            }
        }
        ...
        public final void i0() {
            /*
                ...
                int r0 = r3.f31949f
                int r1 = r3.f31948e
                int r1 = com.google.protobuf.WireFormat.a(r1)
                r2 = 4
                int r1 = com.google.protobuf.WireFormat.c(r1, r2)
                r3.f31949f = r1
            L_0x000f:
                int r1 = r3.J()
            ...
            L_0x0027:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.BinaryReader.SafeHeapReader.i0():void");
        }

        public final boolean j() {
            return this.f31946c == this.f31947d;
        }
        ...
        public final Object l(WireFormat.FieldType fieldType, Class cls, ExtensionRegistryLite extensionRegistryLite) {
            switch (AnonymousClass1.f31943a[fieldType.ordinal()]) {
                case 1:
        ...
        public void o(List list) {
            ...
            if (list instanceof IntArrayList) {
                ...
                if (b2 == 0) {
                    ...
                    int b0 = this.f31946c + b0();
                    while (this.f31946c < b0) {
                        intArrayList.g0(CodedInputStream.b(b0()));
                    }
                } else {
                    throw InvalidProtocolBufferException.e();
                }
