...
public final class Field extends GeneratedMessageLite<Field, Builder> implements FieldOrBuilder {
    ...
    private Internal.ProtobufList<Option> options_ = GeneratedMessageLite.J();
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f32117a     // Catch:{ NoSuchFieldError -> 0x001d }
                com.google.protobuf.GeneratedMessageLite$MethodToInvoke r1 = com.google.protobuf.GeneratedMessageLite.MethodToInvoke.NEW_BUILDER     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = f32117a     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.google.protobuf.GeneratedMessageLite$MethodToInvoke r1 = com.google.protobuf.GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = f32117a     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.google.protobuf.GeneratedMessageLite$MethodToInvoke r1 = com.google.protobuf.GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = f32117a     // Catch:{ NoSuchFieldError -> 0x003e }
                com.google.protobuf.GeneratedMessageLite$MethodToInvoke r1 = com.google.protobuf.GeneratedMessageLite.MethodToInvoke.GET_PARSER     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = f32117a     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.google.protobuf.GeneratedMessageLite$MethodToInvoke r1 = com.google.protobuf.GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = f32117a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    public enum Cardinality implements Internal.EnumLite {
        ...
        public static final class CardinalityVerifier implements Internal.EnumVerifier {
            ...
            /* renamed from: a  reason: collision with root package name */
            public static final Internal.EnumVerifier f32121a = null;

            static {
                f32121a = new CardinalityVerifier();
            }

            public boolean a(int i2) {
                return Cardinality.f(i2) != null;
            }
        }

        static {
            F = new Internal.EnumLiteMap<Cardinality>() {
                /* renamed from: b */
                public Cardinality a(int i2) {
                    return Cardinality.f(i2);
                }
            };
        }
    ...
    public enum Kind implements Internal.EnumLite {
        ...
        public static final Internal.EnumLiteMap U = null;
        ...
        public static final class KindVerifier implements Internal.EnumVerifier {
            ...
            /* renamed from: a  reason: collision with root package name */
            public static final Internal.EnumVerifier f32125a = null;

            static {
                f32125a = new KindVerifier();
            }

            public boolean a(int i2) {
                return Kind.f(i2) != null;
            }
        }

        static {
            U = new Internal.EnumLiteMap<Kind>() {
                /* renamed from: b */
